...
https://help.adjust.com/ja/article/datascape
...
<Accordion title="アコーディオンの例" badge="iOS"> 
...
<Callout title="デフォルトのカスタムラベル付きコールアウト"> 
...
| `grouping`            | 文字列     | クエリ   | パラメーターをグループ化。詳細については、[結果のグループ化](/ja/api/kpi-service/grouping)をご覧ください。 |
