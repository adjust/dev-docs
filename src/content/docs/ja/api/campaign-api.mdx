...
<tabs> <tab title="v2" sync="v2"> <codeblock title="エンドポイント" highlight="/partners"> 
...
<tabs> <tab title="v2" sync="v2"> <codeblock title="エンドポイント" highlight="{app_token}/trackers"> 
...
</CodeBlock> </Tab> </Tabs> ## リンクを更新する {#update-links} <tabs> <tab title="v2" sync="v2"> <codeblock title="エンドポイント" highlight="{app_token}/trackers/{link_token}"> 
