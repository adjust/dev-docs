...
<Tabs>
<Tab title="v2" sync="v2"> <CodeBlock title="エンドポイント">
...
<Tabs>
<Tab title="v2" sync="v2"> <CodeBlock title="cURL" highlight="advertising_id=1234-5678-9012-3456, app_token=gwzpeepw8uf8">
