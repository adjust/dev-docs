...
<Tabs>
<Tab title="Kotlin" sync="kotlin"> <CodeBlock title="Google Play ストアリファラー">
...
<Tabs>
<Tab title="Kotlin" sync="kotlin"> <CodeBlock title="インド URL戦略">
...
<Tabs>
<Tab title="Kotlin" sync="kotlin"> <CodeBlock title="Google Play ADIDゲッター">
