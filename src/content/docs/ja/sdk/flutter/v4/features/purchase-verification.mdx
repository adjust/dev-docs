...
<Tabs>
<Tab title="App Store" icon="StoreAppStore" sync="appstore"> <CodeBlock title="メソッドシグネチャー">
...
<Tab title="Google Play" icon="PlatformGooglePlay" sync="playstore"> <CodeBlock title="メソッドシグネチャー">
