...
</Callout> <tabs> <tab title="Cocoapods" sync="cocoapods"> <callout type="important"> 

問題を回避するために、Adjust SDKがdependencyマネージャーを使用せずに連携されていることを確認してください。
</Callout> 
...
</Tab> <tab title="Swift Package Manager" sync="swift-package-manager"> <callout type="important"> 
