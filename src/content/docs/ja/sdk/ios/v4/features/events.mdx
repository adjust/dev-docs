...
slug: ja/sdk/ios/v4/features/events
versions:
   - label: v5
     value: v5
     default: true
...
</Tabs> <CodeBlock title="イベントログ" collapse="6-40">
...
</Tabs> <CodeBlock title="イベントログ" highlight="{range: 4}">
