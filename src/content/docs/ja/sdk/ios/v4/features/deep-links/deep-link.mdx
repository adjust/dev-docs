...
-  [ ] [必要なディープリンクデータを全て取得していること。](/en/sdk/ios/features/deep-links/data-points)
-  [ ] AppViewでのアプリのブランドドメインの設定とXcodeでのディープリンク設定を行っている[アプリのダイレクトディープリンク](/en/sdk/ios/features/deep-links/direct)
