...
IDは`<app_id_prefix id="sl-md0000000">.<bundle_id id="sl-md0000000">`としてフォーマットされます。例： `ABC1234567.com.example.app`
...
リンク解析ドメインは、メール、SMS、QRコード、リンクを短縮するプラットフォームを介したディープリンクに必要です。[リンク解析](https://help.adjust.com/en/article/link-resolution)がアプリに必要かどうか、マーケティングチームに確認してください。
</Callout> 
