...
SDK v5には、 [SDKシグネチャーライブラリ](https://help.adjust.com/ja/article/sdk-signature)が含まれています。連携が正常に機能することを確認するためには、[テストガイド](/ja/sdk/android/integrations/signature-library#test-your-app)を参照してください。
