...
Adjustで広告収益情報を記録するには、 `TradPlusSdk.setGlobalImpressionListener`関数内で`AdjustAdRevenue`インスタンスを作成します。詳細については、 [広告収益情報の送信](/en/sdk/android/features/ad-revenue)をご覧ください。
