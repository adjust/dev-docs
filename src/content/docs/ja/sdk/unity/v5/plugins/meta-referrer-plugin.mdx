...
Adjust SDK には、Metaに[必要とされる](https://developers.facebook.com/docs/app-ads/meta-install-referrer#step-1--add-the-meta-apps) `<queries id="sl-md0000000">`要素がバンドルされています。これらを `AndroidManifest.xml` に追加する必要はありません。
</Callout> 
