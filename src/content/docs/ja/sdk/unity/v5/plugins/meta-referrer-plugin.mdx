...
slug: ja/sdk/unity/plugins/meta-referrer-plugin
versions:
   - label: v5
     value: v5
     default: true
   - label: v4
     value: v4
redirects:
   v4: /ja/sdk/unity/v4#meta-referrer-integration
---

<Callout type="note">

Adjust SDK には、Metaに[必要とされる](https://developers.facebook.com/docs/app-ads/meta-install-referrer#step-1--add-the-meta-apps) `<queries>`要素がバンドルされています。これらを `AndroidManifest.xml` に追加する必要はありません。
