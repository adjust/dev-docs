...
-  The TTL (time-to-live) for shorts links created using the Deep link generator API is 120 days.
   -  The expiry date of your short link is reset to 120 days when your short link is clicked if the remaining expiry time is less than or equal to 119 days.
...
-  If you've [set up data residency](https://help.adjust.com/en/article/data-residency-setup), make sure you're using the same region for your iOS and Android apps.
