...
If you track ad revenue yourself, you can share this data server-to-server (S2S) to view it with all your other Adjust-measured metrics. This gives a complete overview of your campaign performance, letting you calculate your users’ Lifetime Value (LTV) and optimize your campaign Return on Ad Spend (ROAS) and Return on Investment (ROI).
