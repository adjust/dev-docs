...
slug: en/en/api/ad-spend-api
---

The Partner ad spend API allows you to send the advertising cost information associated with a campaign. The API requires a cost id associated with the campaign to track.
