...
-  -  `grouping`
   -  String
   -  Query
   -  Grouping parameters. [See Result grouping](/en/api/kpi-service/grouping) for more information.
-  -  `tracker_filter`
   -  String
   -  Query
...
```http "/{app_token}/trackers/{tracker_token}/cohorts"
