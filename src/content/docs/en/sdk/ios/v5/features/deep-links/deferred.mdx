...
5. Your app receives the deep link through the Adjust SDK and can handle it as
   needed

## Setup {#setup}

To implement deferred deep linking, update your AppDelegate with the following:
