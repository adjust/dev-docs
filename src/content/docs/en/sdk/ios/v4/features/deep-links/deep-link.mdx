...
- [ ] [Retrieved all the required deep linking data](/en/sdk/ios/features/deep-links/data-points).
- [ ] [Configured direct deep linking for your app](/en/sdk/ios/features/deep-links/direct) that includes setting up a branded domain for your app in AppView and configuring deep links in Xcode.
