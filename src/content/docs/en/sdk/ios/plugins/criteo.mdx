...
3. In the dialog choose options for adding these files. Make sure to check the checkbox to <GuiLabel>Copy items</GuiLabel> if needed and select the radio button to <GuiLabel>Create groups</GuiLabel>.
