...
For more information about the `rewardedAd.OnPaidEvent` method, see [AD(X)'s rewarded ad documentation](hhttps://docs.adxcorp.kr/unity/sdk-integration/ad-formats/rewarded-ad/ad-x#id-4.-a-d-revenue-onpaidevent)
