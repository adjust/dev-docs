...
To see how this integration works in context, check out AppLovin's [example iOS application](https://github.com/AppLovin/AppLovin-MAX-Unity-Plugin/blob/954030309d991fff76e9dbf31001055456472b62/DemoApp/Assets/Scripts/HomeScreen.cs#L513-L524).
