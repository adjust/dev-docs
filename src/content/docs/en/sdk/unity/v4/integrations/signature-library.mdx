...
When validating or submitting apps built with Xcode 16, you might encouter a `Upload symbols failed` warning related to the Signature library. The lack of said symbols is intentional. The warning does not impact functionality and is safe to ignore.
