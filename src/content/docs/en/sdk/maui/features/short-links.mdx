...
slug: en/sdk/maui/features/short-links
sidebar-position: 12
---
...
-  [URI schemes](/en/sdk/maui/features/deep-links)
-  [Deferred deep linking](/en/sdk/maui/features/deep-links#deferred-deep-linking)
