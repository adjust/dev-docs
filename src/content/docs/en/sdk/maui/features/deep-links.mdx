...
There, the mentioned **Identifier** in the [custom url scheme iOs deep linking guide](/en/sdk/ios/features/deep-links/direct#custom-url-scheme) should be part of the info.plist file such as:
...
There, the mentioned `Adjust Universal Link domain` in the [adjust universal links iOs deep linking guide](/en/sdk/ios/features/deep-links/direct#adjust-universal-links-domain) should be part of the entitlement.plist file such as:
