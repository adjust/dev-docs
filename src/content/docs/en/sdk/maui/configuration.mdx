...
If you want to use the external device ID in your business analytics, you can pass it as a [session callback parameter](/en/sdk/maui/features/session-parameters).
...
Cost data is accessible in the user's [attribution information](/en/sdk/maui/features/attribution).
