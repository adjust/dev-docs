...
You can set your log level by passing a <Tooltip>`logLevel` method || <SetLogLevelSig /></Tooltip> value as the fourth positional argument of the `AdjustConfig` constructor.
