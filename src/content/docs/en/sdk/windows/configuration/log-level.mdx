...
You can set your log level by setting the <Tooltip>`logLevel` property || <SetLogLevelSig /></Tooltip> as the fourth positional argument of the `AdjustConfig` constructor.
