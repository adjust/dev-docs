...
2. Run the below `apksigner` command, replacing the parameter:
   ...
   ```
3. Retrieve the SHA1 and/or SHA256 values from the output:
...
<Callout type="note">
The Adjust dashboard requires SHA-256 certificate fingerprints to be entered with colons separating each pair of characters (for example: 55:fb:97:0f:46:0f:94:ec:07:ea:01:69:50:5a:20:3f:a0:91:60:a4:f1:33:58:ea:76:dc:54:9e:a7:6a:b9:1a).
