...
versions:
   ...
   - label: v4
     value: v4
redirects:
   v4: /en/sdk/flutter/v4/features/preinstalled
---
...
Your config object contains a `bool` `isPreinstallTrackingEnabled` property that controls this feature. To enable preinstall measurement, assign a `bool` value to the `isPreinstallTrackingEnabled` property of your config object.
