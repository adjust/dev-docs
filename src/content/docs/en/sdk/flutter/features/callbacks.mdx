...
This example demonstrates how to register a `sessionSuccessCallback` that prints the timestamp at which the SDK sent the session data to Adjust.
...
This example demonstrates how to register a `sessionFailureCallback` that prints the reason the SDK failed to send the session data.
...
This example demonstrates how to register a `eventSuccessCallback` that prints the timestamp at which the SDK sent the event data to Adjust.
...
This example demonstrates how to register a `eventFailureCallback` that prints the reason the SDK failed to send the event data.
