...
In previous versions of the SDK, you needed to pass your endpoint in the `customUrl` property of the `initSdk` method. However, it is now deprecated. To set your custom endpoint in the current SDK, use the `urlStrategy` configuration instead.
