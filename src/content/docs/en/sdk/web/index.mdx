...
To make Web SDK work properly, you must create a dedicated web app for web tracking in the Adjust dashboard and then apply it to the corresponding web app. If you apply the Web SDK to a mobile app that already has the Mobile App SDK, it will not work properly.
