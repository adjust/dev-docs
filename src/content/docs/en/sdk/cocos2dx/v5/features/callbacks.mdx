...
versions:
   ...
   - label: v4
     value: v4
redirects:
   v4: /en/sdk/cocos2dx/v4/features/callbacks
---
...
### Success callbacks {#session-success-callbacks}
...
### Failure callbacks {#session-failure-callbacks}
...
### Success callbacks {#event-success-callbacks}
...
### Failure callbacks {#event-failure-callbacks}
