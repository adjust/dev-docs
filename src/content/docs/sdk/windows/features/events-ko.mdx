...
-  `eventToken` \( **문자열** \): Adjust [이벤트 토큰](https://help.adjust.com/ko/article/add-events#manage-your-events).
...
본 예시에서는 사용자가 버튼을 조작할 때마다 _`g3mfiw`_ 라는 토큰으로 이벤트를 기록하는 방법을 보여줍니다. 이 함수로 `PurchaseId` 속성이 `5e85484b-1ebc-4141-aab7-25b869e54c49`로 설정됩니다.
