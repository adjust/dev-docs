...
## [1\. プロジェクトにAdjust SDKを追加する](1-add-the-adjust-sdk-to-your-project)
...
### [パッケージマネージャーコンソールを使用](using-the-package-manager-console)
...
## [4\. Adjust SDKを設定する](4-configure-the-adjust-sdk)
...
## [5\. アプリのビルドとデバッグ](5-build-and-debug-your-app)
