...
![Solution Explorer 中的 NuGet Package Manager 窗口截图。](https://images.ctfassets.net/5s247im0esyq/WoSgxyiYvWtniwATXAkRG/72d59e5ede930c5bcb3c481231dd49d1/NuGet-windows-sdk.png)
...
* `appToken`: 应用识别码。
* `environment`: SDK 运行的环境。将其发送至`AdjustConfig.EnvironmentSandbox`。
...
添加 config 对象和初始化逻辑后，您可以配置 Adjust SDK 来记录应用不同部分的信息。查看 SDK[配置](/en/sdk/windows/configuration)和[功能](/en/sdk/windows/features)指南，设置您想要记录的信息。
...
![Visual Studio debugger 截屏。](https://images.ctfassets.net/5s247im0esyq/2bwuTMNnQ5B6QTa1J4e0s1/3031edd8993fe6de0cd07136f98e17f2/Debug-Windows-SDK.png)
