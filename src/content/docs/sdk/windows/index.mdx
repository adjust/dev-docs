...
## 1. Add the Adjust SDK to your project {#1-add-the-adjust-sdk-to-your-project}
...
## 4. Configure the Adjust SDK {#4-configure-the-adjust-sdk}
...
## 5. Build and debug your app {#5-build-and-debug-your-app}
