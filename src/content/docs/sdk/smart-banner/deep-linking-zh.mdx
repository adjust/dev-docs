...
-  [Pass parameters to the `AdjustSmartBanner.init` function](/zh/sdk/smart-banner/init-options#configure-deep-links).
...
-  [In the `init` function](/zh/sdk/smart-banner/init-options#configure-deep-links)
