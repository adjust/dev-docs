...
-  [`AdjustSmartBanner.init`関数にパラメーターをパスする](/en/sdk/smart-banner/init-options#configure-deep-links)。
...
-  [`init`関数内](/en/sdk/smart-banner/init-options#configure-deep-links)
