...
-  [Pass parameters to the `AdjustSmartBanner.init` function](/ja/sdk/smart-banner/init-options#configure-deep-links).
...
-  [In the `init` function](/ja/sdk/smart-banner/init-options#configure-deep-links)
