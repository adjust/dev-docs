...
-  [`AdjustSmartBanner.init` 함수에 파라미터를 전달합니다](/en/sdk/smart-banner/init-options#configure-deep-links).
...
-  [`init` 함수](/en/sdk/smart-banner/init-options#configure-deep-links)
