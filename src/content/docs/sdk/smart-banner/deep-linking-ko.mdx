...
-  [Pass parameters to the `AdjustSmartBanner.init` function](/ko/sdk/smart-banner/init-options#configure-deep-links).
...
-  [In the `init` function](/ko/sdk/smart-banner/init-options#configure-deep-links)
