...
CDN을 통해 스마트 배너 SDK를 로드하려면 페이지의 `<head id="sl-md0000000">` 태그에 다음 스니펫을 붙여 넣습니다.
...
설정 옵션의 전체 목록은 [초기화 옵션](/en/sdk/smart-banner/init-options)을 확인하시기 바랍니다.

</Callout>

## [3\. 배너 로컬라이제이션](3-localize-your-banners)
