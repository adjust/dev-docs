...
如果您已启用[购买验证](https://help.adjust.com/en/article/purchase-verification)，则必须随购买事件一同发送额外信息用于验证。Adjust 服务器收到`ADJEvent`对象中的信息后，会将此信息转发至 Apple 验证购买。
...
请参阅[发送事件信息](/en/sdk/ios/features/events)了解有关`ADJEvent`类的更多信息。
