...
-  [Reattribution with deep links](/en/sdk/ios/features/deep-links/direct#modify-your-ios-app)

<callout type="note">
   You don't need to set up LinkMe or [Link
   resolution](/en/sdk/ios/features/deep-links/resolution) to use Adjust’s link
   shortener solution.
</callout>
