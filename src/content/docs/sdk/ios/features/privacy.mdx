...
You can prevent the Adjust SDK from reading a device's IDFA by calling the `[ADJConfig disableIdfvReading]` method. When you call this method, the Adjust SDK is prevented from reading the device's IDFV and sending it to Adjust.
