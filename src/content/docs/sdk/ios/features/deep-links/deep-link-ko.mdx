...
[맞춤 URL 스킴을 가진 딥링크 설정](set-up-deep-links-with-a-custom-url-scheme)
------------------------------------------------------------------
...
4. 트래커 URL에 `deeplink_js=1` 파라미터와 함께 암호화된 딥링크를 추가합니다. 이는 Adjust 시스템이 iOS 맞춤 URL 스킴을 사용하도록 합니다. 예시: `https://app.adjust.com/abc123?deeplink_js=1&deeplink=%3A%2F%2Fsummer-clothes%3Fpromo%3Dbeach`
