...
-  Check the **Associated Domains** configuration in Xcode.
   ...
   -  The domain in Xcode must match the Adjust **Universal Link domain** or **Branded Link** in the Adjust dashboard. If you are testing different builds (e.g., debug vs. release), you can add the Adjust Universal Link domain or Branded Link in all builds.
