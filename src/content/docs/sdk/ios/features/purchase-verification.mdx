...
If you've enabled [purchase verification](https://help.adjust.com/en/article/purchase-verification), you must send additional information with your purchase events to verify them. When Adjust receives this information in an `ADJEvent` object, it's forwarded to Apple for purchase verification.
