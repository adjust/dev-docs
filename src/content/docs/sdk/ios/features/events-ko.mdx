...
* `transactionId` \( **NSString** \): 성공적으로 완료된 구매의 [`transactionIdentifier`](https://developer.apple.com/documentation/storekit/skpaymenttransaction/1411288-transactionidentifier) 값
* `productId` \( **NSString** \): 성공적으로 구매된 아이템의 제품 식별자
