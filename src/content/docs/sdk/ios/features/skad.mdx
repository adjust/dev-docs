...
| `coarseValue` | `NSString` | The coarse conversion value. This value is used if your app doesn't have sufficient installs to reach the privacy threshold.<ul><li>`low`</li><li>`medium`</li><li>`high`</li></ul>                                                 |
