...
The distribution of static frameworks is deprecated from version 4\.38\.0, as a result of not including the [Privacy Manifest](https://help.adjust.com/ja/article/submit-privacy-details-to-apple#privacy-manifest).
...
Now that you've configured the Adjust SDK to record information about your app, it's time to test it. Adjust offers a [testing console](https://help.adjust.com/ja/article/testing-console) and a [Device API](https://help.adjust.com/ja/article/device-api) to help you test your app.

Follow the [testing guide](https://help.adjust.com/ja/article/test-the-adjust-sdk) to make sure Adjust receives the expected values back from your app.
