...
-  `appToken` \(`NSString`\): Your [Adjust app token](https://help.adjust.com/ja/article/app-token-and-reporting-currency#view-your-app-details).
...
-  `defaultTracker` \(`NSString`\): The [Adjust link token](https://help.adjust.com/ja/article/links#adjust-link-token) you want to record preinstalled installs against.
