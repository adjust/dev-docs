...
SDK v5는 [SDK Signature 라이브러리](https://help.adjust.com/en/article/sdk-signature) 를 포함합니다. 서명 보호는 기본 설정에 따라 비활성화되어 있습니다. 이를 활성화하려면 [서명 검증을 시행](https://help.adjust.com/en/article/sdk-signature#enforce-signature-validation) 해야 합니다.
