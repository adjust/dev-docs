...
2. 将下列参数以[会话合作伙伴参数](https://help.adjust.com/zh/article/session-parameters-ios-sdk#session-partner-parameters)形式发送至 Adjust SDK。只有启用 [Delay Start](https://help.adjust.com/zh/article/session-parameters-ios-sdk#delay-start) \(延迟启动\)，这些参数才会在安装或会话开始时可用。
