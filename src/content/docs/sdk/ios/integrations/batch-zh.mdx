...
要集成 Adjust 和 Batch.com SDK，您需要将归因发送到 Batch.com SDK。收到 Adjust 服务器响应后，您应该发送此信息。为此，请按照[归因回传设置指南](https://help.adjust.com/en/article/attribution-callbacks-ios-sdk)中的步骤进行操作。
