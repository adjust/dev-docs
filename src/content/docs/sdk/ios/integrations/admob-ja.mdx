...
If you have any questions about ad revenue measurement with AdMob, please contact your dedicated account manager or send an email to [support@adjust.com](mailto:support@adjust.com).
</Callout> 
...
</SdkVersion> <sdkversion version="v4"> <minorversion added="v4.29.2"> 
