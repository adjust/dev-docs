...
AdjustとBatch.com SDKを連携するには、Batch.com SDKにアトリビューションを送信する必要があります。Adjustサーバーからレスポンスを受け取った後に情報を送信してください。これを実行するには、[アトリビューションコールバック設定ガイド](https://help.adjust.com/en/article/attribution-callbacks-ios-sdk)の手順に従ってください。
