...
-  Ensure that your app is running in **Sandbox mode** before conducting tests.
...
1. Download the [`AdjustSigSdk-iOS-tvOS-Dynamic-3.13.0.xcframework.zip` archive from GitHub](https://github.com/adjust/adjust_signature_sdk/releases/latest).
