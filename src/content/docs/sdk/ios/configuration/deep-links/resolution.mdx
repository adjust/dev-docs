...
Email service provider (ESP): The underlying infrastructure that sends emails, and manages deliverability to <Abbr>ISP (Internet service provider)</Abbr> emails servers.: **Examples:** SendGrid, SparkPost.
