...
slug: "ko/sdk/ios/migration/web-v4-to-v5"
sidebar-position: 2
...
SDK v4에서 [COPPA 준수](/ko/sdk/android/features/privacy#coppa-compliance) 는 부울 인수와 함께 `AdjustConfig` 인스턴스에서 `setCoppaCompliantEnabled` 메서드를 호출하여 설정됩니다.
...
SDK v4에서는 `AdjustConfig` 인스턴스의 `setLinkMeEnabled` 메서드를 부울 인수와 함께 호출하여 Adjust 웹 브릿지를 통해 [Adjust LinkMe](https://help.adjust.com/ko/article/linkme) 를 활성화할 수 있습니다.
