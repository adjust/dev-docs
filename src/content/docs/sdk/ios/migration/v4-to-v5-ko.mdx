...
</MinorVersion> <tabs> <tab title="Swift" sync="swift"> <codeblock> 
...
</CodeBlock> </Tab> <tab title="Objective-C" sync="objc"> <codeblock> 
...
</CodeBlock> <codeblock title="Attribution getter"> 
