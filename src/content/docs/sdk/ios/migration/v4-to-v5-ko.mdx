...
In SDK v4, [COPPA compliance](/en/sdk/ios/features/privacy#coppa-compliance) is set using the `ADJConfig` class and is read during SDK initialization. This means that the value can't be updated once the SDK is initialized.
</MinorVersion> <tabs> <tab title="Swift" sync="swift"> 
...
</MinorVersion> <tabs> <tab title="Swift" sync="swift"> <code translate="no"> 
...
</Code> </Tab> <tab title="Objective-C" sync="objc"> <code translate="no"> 
...
<tabs> <tab title="Swift" sync="swift"> <code translate="no" title="India URL strategy"> 
...
</Code> </Tab> <tab title="Objective-C" sync="objc"> <code translate="no" title="India URL strategy"> 
...
</MinorVersion> <tabs> <tab title="Swift" sync="swift"> <code translate="no" title="ADID getter"> 
...
</Code> </Tab> <tab title="Objective-C" sync="objc"> <code translate="no" title="ADID getter"> 
