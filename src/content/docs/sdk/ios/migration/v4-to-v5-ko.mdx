...
SDK v5 is currently available only on Cocoapods.
...
2. `Podfile`에 다음 줄을 추가합니다.
   ...
   <code translate="no" title="Podfile">
...
In SDK v4, you can enable [Adjust LinkMe](https://help.adjust.com/ko/article/linkme) by calling the `[ADJConfig setLinkMeEnabled]` method with a `true` argument.
...
In SDK v4, [COPPA compliance](/ko/sdk/ios/features/privacy#coppa-compliance) is set using the `ADJConfig` class and is read during SDK initialization. This means that the value can't be updated once the SDK is initialized.
...
<Tabs> <Tab title="Swift" sync="swift"> <code translate="no">
...
<Tab title="Objective-C" sync="objc"> <code translate="no">
...
| `ADJUrlStrategyChina`  | `"adjust.world"`님 `"adjust.com"`  | `true`                | `false`                 |
| `ADJUrlStrategyCn`     | `"adjust.cn"`님 `"adjust.com"`     | `true`                | `false`                 |
| `ADJUrlStrategyCnOnly` | `"adjust.cn"`                      | `true`                | `false`                 |
| `ADJUrlStrategyIndia`  | `"adjust.net.in"`님 `"adjust.com"` | `true`                | `false`                 |
...
<Tabs>
<Tab title="Swift" sync="swift"> <code translate="no" title="India URL strategy">
...
<Tab title="Objective-C" sync="objc"> <code translate="no" title="India URL strategy">
...
<Tabs> <Tab title="Swift" sync="swift"> <code translate="no" title="ADID getter">
...
</Code> <code translate="no" title="IDFA getter">
...
</Code> <code translate="no" title="IDFV getter">
...
</Code> <code translate="no" title="Attribution getter">
...
<Tab title="Objective-C" sync="objc"> <code translate="no" title="ADID getter">
