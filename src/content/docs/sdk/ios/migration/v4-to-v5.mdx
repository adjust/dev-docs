...
In SDK v4, you can mark your app as COPPA compliant by calling the `[ADJConfig setCoppaCompliantEnabled]` method with a boolean value.
...
In SDK v5, this method has been renamed to `[ADJConfig enableCoppaCompliance]` for clarity. This method takes no arguments.
