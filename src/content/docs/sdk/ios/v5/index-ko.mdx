...
SDK v5는 [SDK Signature 라이브러리](https://help.adjust.com/en/article/sdk-signature)를 포함합니다. [테스트 가이드](/en/sdk/ios/integrations/signature-library#test-your-app)를 참조하여 연동이 잘 작동하는지 확인하시기 바랍니다.
...
* `environment`: 이를 `ADJEnvironmentProduction` 로 설정합니다.
