...
6. The Adjust SDK triggers a deferred deep link callback in the app, which stores the deferred deep link (shown in the AppDelegate implementation above).
