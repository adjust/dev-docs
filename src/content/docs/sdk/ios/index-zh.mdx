...
SDK v5 includes the [SDK signature library](https://help.adjust.com/zh/article/sdk-signature). Signature protection is inactive by default. To enable it, you need to [enforce signature validation](https://help.adjust.com/zh/article/sdk-signature#enforce-signature-validation).
