...
| `AppTrackingTransparency.framework` | Required to allow the Adjust SDK to wrap user ATT consent dialog and access consent responses on devices running iOS 14 or later | 如果您的应用属于 "儿童" 类别，那么请勿添加该框架                                   |
