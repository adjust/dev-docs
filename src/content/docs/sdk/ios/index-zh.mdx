...
* `appToken`: [应用识别码](https://help.adjust.com/en/article/app-settings#view-your-app-token)。
...
* `environment`：将其发送至 `ADJEnvironmentProduction`。
