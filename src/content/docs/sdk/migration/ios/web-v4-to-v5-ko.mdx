...
slug: "ko/sdk/migration/ios/web-v4-to-v5"
sidebar-position: 2
...
SDK v4에서는 부울 인수와 함께 `AdjustConfig` 인스턴스의 `setCoppaCompliantEnabled` 메서드를 호출하여 [COPPA 준수](/ko/sdk/android/features/privacy#coppa-compliance)를 설정합니다.
...
SDK v4에서는 부울 인수와 함께 `AdjustConfig` 인스턴스의 `setLinkMeEnabled` 메서드를 호출하고 Adjust 웹 브릿지를 사용하여 [Adjust LinkMe](https://help.adjust.com/ko/article/linkme)를 활성화할 수 있습니다.
