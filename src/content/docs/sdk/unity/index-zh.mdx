...
Adjust SDK 支持[Meta Install Referrer](https://developers.facebook.com/docs/app-ads/meta-install-referrer) 。要启用该功能：
...
3. 将`AdjustConfig`实例的`FbAppId`属性设置为您的应用 ID。
...
[6\. 测试集成](7-test-your-integration)
------------------------------------
