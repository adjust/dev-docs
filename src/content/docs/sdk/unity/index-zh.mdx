...
## [3\. 设置 安卓 设备](3-set-up-android-devices)
...
-  `com.google.android.gms.permission.AD_ID`: 用于在 安卓 12 \(API level 31\) 及更高版本中读取设备广告 ID。请查看 [Google 的 `AdvertisingIdClient.info` 文档](https://developers.google.com/android/reference/com/google/android/gms/ads/identifier/AdvertisingIdClient.Info#public-string-getid) ，了解更多信息。
