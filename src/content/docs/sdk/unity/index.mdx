...
**iAd.framework** <Badge color="warning">Deprecated</Badge>
...
**com.android.finsky.permission.BIND_GET_INSTALL_REFERRER_SERVICE** <Badge color="warning">Deprecated</Badge>
