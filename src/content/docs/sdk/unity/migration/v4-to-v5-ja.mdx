...
SDK v5には、 [SDKシグネチャーライブラリ](https://help.adjust.com/en/article/sdk-signature)が含まれています。これをテストするには[シグネチャーライブラリ連携ガイド](/en/sdk/unity/integrations/signature-library)の手順に従ってください。
