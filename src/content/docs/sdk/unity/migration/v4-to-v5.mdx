...
To start using SDK v5, you need to add it as a dependency to your project. To do this:
...
Once you've removed SDK v4 from your project, download the Adjust `unitypackage` from [the GitHub releases page](https://github.com/adjust/unity_sdk/releases/tag/v5.0.0-beta1) and import it into your project.
...
The SDK namespace has been renamed from `com.adjust.sdk` to `Adjust.Sdk`.
...
```cs
Adjust.UpdateSkanConversionValue(1, SKAdNetwork.CoarseConversionValue.low, false)
```
