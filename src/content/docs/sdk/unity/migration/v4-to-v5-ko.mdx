...
### [iOS 및 Android SDK 설치](install-ios-and-android-sdks)
...
#### [앱스토어 구독용](app-store-subscriptions)
...
#### [어트리뷰션 변경 콜백](attribution-changed-callback)
...
### [서드파티 공유 변경 사항](third-party-sharing-changes)
...
#### [ATT 팝업 대기 인터벌 구성](configure-att-interval)

<minorversion changed="v5"> 

SDK v4에서는 `AdjustConfig` 인스턴스의 `setAttConsentWaitingInterval` 메서드를 사용하여 Adjust로의 설치 정보 전송을 지연시키는 인터벌을 구성할 수 있습니다. 이러한 지연은 사용자에게 ATT 팝업창을 표시할 시간을 줍니다.
</MinorVersion> 
...
</MinorVersion> <codeblock title="IDFA 게터"> 
