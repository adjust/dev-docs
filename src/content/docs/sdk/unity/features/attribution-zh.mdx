...
只有在[您的 `AdjustConfig` 实例 `needsCost` 属性](/zh/sdk/android/configuration#enable-cost-data-sending)为 `true` 的情况下，您才能访问下列值：
...
| `clickLabel`        | 字符串   | 安装被标记的[点击标签](https://help.adjust.com/zh/article/user-rewards)                                     |
...
| `fbInstallReferrer` | 字符串   | [Facebook install referrer](https://developers.facebook.com/docs/app-ads/install-referrer/)， _仅限安卓_ 。 |
