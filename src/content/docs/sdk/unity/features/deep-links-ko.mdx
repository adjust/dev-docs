...
![Unity 에디터 스크린샷](https://images.ctfassets.net/5s247im0esyq/4zj31Hg4AXE8WDKKqbz5xM/1535bc4d75e1b4ad826c002c7e9fe61a/ios_deeplinks.png)
...
5. **iOS Universal Links Domain** 필드에 유니버설 링크를 입력합니다. `https://` 프로토콜을 다음 항목으로 교체합니다. `applinks:`
...
![Unity prefab 메뉴의 Android URI 스킴 섹션 스크린샷](https://images.ctfassets.net/5s247im0esyq/3NYo4ctARqUSwJJz7wyOjI/276b2699ef82fc0ab72989a5aaa2b347/android_uri_schemes.png)
