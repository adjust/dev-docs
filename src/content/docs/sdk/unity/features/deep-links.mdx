...
The SDK opens deferred deep links by default. You can configure this by assigning a `bool` value to the `IsDeferredDeeplinkOpeningEnabled` property of your `AdjustConfig` instance.
