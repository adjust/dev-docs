...
```cs
public Action<adjustsessionsuccess id="sl-md0000000"> SessionSuccessDelegate { get; set; }
```
...
```cs
public Action<adjustsessionfailure id="sl-md0000000"> SessionFailureDelegate { get; set; }
```
...
```cs
public Action<adjusteventsuccess id="sl-md0000000"> EventSuccessDelegate { get; set; }
```
...
```cs
public Action<adjusteventfailure id="sl-md0000000"> EventFailureDelegate { get; set; }
```
