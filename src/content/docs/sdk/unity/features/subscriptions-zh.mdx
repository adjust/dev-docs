...
您可以记录用户购买订阅的地区。为此，请将`AdjustPlayStoreSubscription`实例的`SalesRegion`属性设置为`string`形式的国家代码。此信息需为[`priceLocale`](https://developer.apple.com/documentation/storekit/skproduct/1506145-pricelocale?language=swift)对象的[`countryCode`](https://developer.apple.com/documentation/foundation/nslocale/1643060-countrycode?language=swift)。
