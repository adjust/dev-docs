...
![Unity Editor 截屏](https://images.ctfassets.net/5s247im0esyq/4zj31Hg4AXE8WDKKqbz5xM/1535bc4d75e1b4ad826c002c7e9fe61a/ios_deeplinks.png)
...
![Unity prefab 菜单 Android URI Schemes 部分截屏](https://images.ctfassets.net/5s247im0esyq/3NYo4ctARqUSwJJz7wyOjI/276b2699ef82fc0ab72989a5aaa2b347/android_uri_schemes.png)
...
SDK 默认自动打开延迟深度链接，您可以通过传递一个 **布尔** 参数至 `setLaunchDeferredDeeplink` 方法来对此进行配置。
