...
사용자가 구독을 구매한 지역을 기록할 수 있습니다. 이를 위해 `AdjustPlayStoreSubscription` 인스턴스의 `SalesRegion` 속성을 `string` 의 국가 코드로 설정합니다. 이는 [countryCode">https://developer.apple.com/documentation/storekit/storefront](<code translate=) 객체의 [string">https://developer.apple.com/documentation/storekit/storefront/3792000\-countrycode](<code translate=)로 포맷되어야 합니다.
