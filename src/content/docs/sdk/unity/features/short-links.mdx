...
To resolve a shortened deep link, call the `Adjust.ProcessAndResolveDeeplink` method and pass a callback function. The callback function receives the resolved deep link as a `string`.
...
// ...
Adjust.ProcessAndResolveDeeplink("your-deeplink", DeeplinkResolvedCallback);
```
