...
slug: ko/sdk/unity/integrations/adx
versions:
   - label: v5
     value: v5
     default: true
   - label: v4
     value: v4
redirects:
   v4: /ko/sdk/unity/v4/integrations/adx
---
...
2. `"adx_sdk"` 소스를 사용하여 [`AdjustAdRevenue` 객체](/ko/sdk/unity/features/ad-revenue)를 인스턴스화합니다.
