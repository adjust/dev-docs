...
versions:
   ...
   - label: v4
     value: v4
redirects:
   v4: /en/sdk/unity/v4/features/att
---
...
The Adjust SDK also records the consent status if you use a custom prompt. If you show your prompt before initialization, the SDK sends the status either:

1. As soon as the [custom prompt timer](#custom-prompt-timing) ends or
2. The next time the Adjust SDK sends information to Adjust.
