...
앱에 Adjust SDK를 연동하려면 [연동 가이드](/en/sdk/unity)를 참조하시기 바랍니다.

[예시](example)
-------------

Adjust와의 광고 매출 정보를 기록하려면 `OnGlobalAdImpression` 함수 내에서 `AdjustAdRevenue` 인스턴스를 생성하시기 바랍니다. 자세한 내용은 [광고 매출 정보 전송 가이드](/en/sdk/unity/features/ad-revenue) 를 참조하시기 바랍니다.
