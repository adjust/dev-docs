...
[連携ガイド](/en/sdk/unity)に従ってAdjust SDKをアプリに実装してください。

[例](example)
------------

Adjustで広告収益情報を記録するには、 `OnGlobalAdImpression`関数内で`AdjustAdRevenue`インスタンスを作成します。詳細については、 [広告収益情報の送信](/en/sdk/unity/features/ad-revenue)をご覧ください。
