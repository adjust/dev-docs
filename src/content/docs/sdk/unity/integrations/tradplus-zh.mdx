...
要将 Adjust SDK 集成进应用，请按[集成指南](/en/sdk/unity)中的说明操作。

[示例](example)
-------------

如需通过 Adjust 记录广告收入信息，请在`OnGlobalAdImpression`函数中创建一个`AdjustAdRevenue`实例。请参阅[发送广告收入信息指南](/en/sdk/unity/features/ad-revenue)了解更多信息。
