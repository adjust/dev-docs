...
3. AdjustはSKAdNetworkデータを[Datascape](https://help.adjust.com/en/suite/article/datascape)および[データキャンバス](https://help.adjust.com/en/classic/article/data-canvas-classic)に表示します。
