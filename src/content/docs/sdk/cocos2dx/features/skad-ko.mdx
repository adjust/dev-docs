...
3. Adjust는 SKAdNetwork 데이터를 [Datascape](https://help.adjust.com/en/suite/article/datascape)과 [Data Canvas](https://help.adjust.com/en/classic/article/data-canvas-classic)에 표시합니다.
