...
slug: ja/sdk/android/v4/integrations/adx
versions:
   - label: v5
     value: v5
     default: true
   - label: v4
     value: v4
redirects:
   v5: /ja/sdk/android/integrations/adx
---
...
2. ソース`AdjustConfig.AD_REVENUE_ADX`で[`AdjustAdRevenue`オブジェクト](/ja/sdk/android/features/ad-revenue)をインスタンス化します。
