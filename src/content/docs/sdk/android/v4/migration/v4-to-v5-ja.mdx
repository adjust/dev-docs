...
In SDK v4, you can mark an app as a [Play Store Kids app](/ja/sdk/android/features/privacy#play-store-kids-apps) by calling the `setPlayStoreKidsAppEnabled` method on your `AdjustConfig` instance with a boolean argument.
