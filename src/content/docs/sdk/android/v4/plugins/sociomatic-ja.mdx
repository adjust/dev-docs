---
<<<<<<<< HEAD:src/content/docs/sdk/android/v4/plugins/sociomatic-ja.mdx
title: "Sociomatic"
description: "Sociomaticプラグインを使用して、Sociomaticの情報をAdjustにパスします。"
slug: "ja/sdk/android/v4/plugins/sociomatic"
|||||||| 74cb01804:src/content/docs/sdk/android/plugins/sociomatic-ja.mdx
title: "Sociomatic"
description: "Sociomaticプラグインを使用して、Sociomaticの情報をAdjustにパスします。"
...
multiVersion: true
>>>>>>>> main:src/content/docs/sdk/android/v5/plugins/sociomantic-ja.mdx
---
