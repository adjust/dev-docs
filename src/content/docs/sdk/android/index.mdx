...
## [3. Add permissions](3-add-permissions)
...
The Adjust SDK supports the [Meta Install Referrer](https://developers.facebook.com/docs/app-ads/meta-install-referrer) using the Adjust Meta Install Referrer plugin. To enable this feature:

1. Install the Adjust Meta Install Referrer plugin by adding the following dependency to your `build.gradle` file:
...
## [6. Integrate the Adjust SDK](6-integrate-the-adjust-sdk)
...
## [7. Configure session recording](7-configure-session-recording)
...
## [8. Build your app for production](8-build-your-app-for-production)
