---
title: "Android Web bridge v5 마이그레이션 가이드"
description: "본 가이드를 참조하여 Android Web Bridge를 SDK v4에서 SDK v5로 업그레이드하시기 바랍니다."
...
SDK v4에서 [COPPA 준수](/en/sdk/android/features/privacy#coppa-compliance) 는 boolean 인수와 함께 config 객체의 `setCoppaCompliantEnabled` 메서드를 호출하여 설정됩니다.
...
SDK v4에서는 boolean 인수와 함께 config 객체의 `setPlayStoreKidsAppEnabled` 메서드를 호출하여 앱을 [Play Store Kids 앱](/en/sdk/android/features/privacy#play-store-kids-apps) 으로 표시할 수 있습니다.
