...
```kotlin
- Adjust.appWillOpenUrl(data, applicationContext) //v4
+ Adjust.processDeeplink(data, applicationContext) //v5
```
...
</MinorVersion> <tabs> <tab title="Kotlin" sync="kotlin"> <codeblock title="ADIDゲッター"> 
...
</CodeBlock> </Tab> <tab title="Java" sync="java"> <codeblock title="ADIDゲッター"> 
