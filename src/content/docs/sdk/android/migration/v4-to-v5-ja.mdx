...
SDK v4では、[COPPA準拠](/en/sdk/android/features/privacy#coppa-compliance)は`AdjustConfig`クラスを使用して設定され、SDKの初期化中に読み込まれます。つまり、SDKを初期化したら値を更新することはできません。
</MinorVersion> <tabs> <tab title="Kotlin" sync="kotlin"> 
...
</MinorVersion> <tabs> <tab title="Kotlin" sync="kotlin"> <codeblock title="Google Play Store Referrer"> 
...
</CodeBlock> </Tab> <tab title="Java" sync="java"> <codeblock title="Google Play Store Referrer"> 
