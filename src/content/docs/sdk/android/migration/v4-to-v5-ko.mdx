...
<tabs> <tab title="Kotlin" sync="kotlin"> <codeblock title="Google 플레이 스토어 리퍼러"> 
...
<tabs> <tab title="Kotlin" sync="kotlin"> <codeblock title="Google Play ADID getter"> 
