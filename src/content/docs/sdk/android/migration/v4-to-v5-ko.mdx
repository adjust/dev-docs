...
SDK v5 includes the [SDK signature library](https://help.adjust.com/ko/article/sdk-signature). You can test this by following the testing steps in the [Signature library integration guide](/en/sdk/android/integrations/signature-library).
