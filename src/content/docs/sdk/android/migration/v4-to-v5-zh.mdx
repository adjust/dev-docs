...
<tabs> <tab title="Kotlin" sync="kotlin"> <codeblock title="印度 URL 策略"> 
...
</CodeBlock> </Tab> <tab title="Java" sync="java"> <codeblock title="印度 URL 策略"> 
...
</MinorVersion> <tabs> <tab title="Kotlin" sync="kotlin"> <codeblock title="Google Play 应用商店 referrer"> 
...
</CodeBlock> <codeblock title="小米 Install Referrer"> 
...
</CodeBlock> </Tab> <tab title="Java" sync="java"> <codeblock title="Google Play 应用商店 referrer"> 
