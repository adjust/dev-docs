...
In SDK v4, you can mark your app as COPPA compliant by calling the `AdjustConfig.setCoppaCompliantEnabled` method with a boolean value.
...
In SDK v5, this method has been renamed to `AdjustConfig.enableCoppaCompliance` for clarity. This method takes no arguments.
...
In SDK v4, you can mark an app as a [Play Store Kids app](/en/sdk/android/features/privacy#play-store-kids-apps) by calling the `AdjustConfig.setPlayStoreKidsAppEnabled` method with a boolean argument.
...
In SDK v5, this method has been renamed to `AdjustConfig.enablePlayStoreKidsCompliance` for clarity. This method takes no arguments.
