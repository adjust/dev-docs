...
Meta Install Referrer 插件捆绑了[Meta 要求](https://developers.facebook.com/docs/app-ads/meta-install-referrer#step-1--add-the-meta-apps)的`<queries>`元素。您无需将这些元素添加至`AndroidManifest.xml`。
