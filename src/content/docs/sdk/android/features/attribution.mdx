...
To configure your callback function, call the <Tooltip> `setOnAttributionChangedListener` method || <SetOnAttributionChangedListenerSig /></Tooltip> with your function name as an argument.
