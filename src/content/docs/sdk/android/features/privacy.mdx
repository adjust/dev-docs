...
To enable or disable third party sharing with the Adjust SDK, you need to instantiate an `AdjustEvent` object. This object contains variables that control how third party sharing is handled by Adjust.
