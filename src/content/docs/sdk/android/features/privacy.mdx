...
To mark your app as a Play Store Kids App, call the `Adjust.enablePlayStoreKidsCompliance` method any time during or after SDK initialization.
...
You can unmark your app as a Play Store Kids App at any time by calling the `Adjust.disablePlayStoreKidsCompliance` method during or after SDK intialization.
