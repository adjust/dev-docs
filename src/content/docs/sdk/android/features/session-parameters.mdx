...
You can remove all session parameters if they're no longer required. To do this, call the `Adjust.resetGlobalCallbackParameters` method.
...
You can remove all global partner parameters if they're no longer required. To do this, call the `Adjust.resetGlobalPartnerParameters` method.
