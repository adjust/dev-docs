...
[구매 검증](https://help.adjust.com/ko/article/purchase-verification)을 활성화한 경우 검증을 위해 구매 이벤트와 함께 추가 정보를 전송해야 합니다.Adjust의 서버가 이벤트 객체를 통해 해당 정보를 수신하면, 해당 정보를 Google에 전달하여 구매를 인증합니다.
