...
Adjust를 Google FCM에 연결하는 데 필요한 프라이빗 키 세부 사항을 확인했다면 [AppView의 앱 구성](https://help.adjust.com/en/article/platforms-ios-android-amazon-microsoft)에서 삭제 및 재설치 측정을 다음과 같이 활성화해야 합니다.
...
3. 앱을 실행합니다.
4. Adjust의 [테스팅 콘솔](https://help.adjust.com/en/article/testing-console)을 실행합니다.
