...
The Adjust SDK delivers deep link information within your activity's intent object using either the `initSdk` or `onNewIntent` method. You can access deep link content once the app is launched and one of these methods has fired. You can then access this information in other parts of your app.
