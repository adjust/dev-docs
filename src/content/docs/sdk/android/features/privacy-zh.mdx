...
* `domains` \(`List<string id="sl-md0000000">`\): The country or countries of data residence, or the endpoints to which you want to send SDK traffic.
...
|          URL 策略           |     Main and fallback domain      | Use sub domains | Is Data Residency |
|---------------------------|-----------------------------------|-----------------|-------------------|
