...
Adjust enables you to run re\-engagement campaigns with usage of deep links. For more information, check out how to set up [Deep links in Campaign Lab](https://help.adjust.com/zh/article/deep-links).
...
-  `url` \( **字符串** \)：打开应用的深度链接。
-  `resolveUrlSuffixArray` \( **String array** \) \- 需要解析的、已设置推广活动的自定义域名。
