...
4. [Android アプリリンク](https://help.adjust.com/ja/article/set-up-android-app-links)については、 `intent`フィルターを追加して、アプリが処理できるURLを指定します。`intent`フィルターで、 `data`要素を`android:autoVerify="true"`アトリビュートとともに含めます。
