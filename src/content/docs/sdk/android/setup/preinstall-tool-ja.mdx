...
| ----------------- | ------------ | -------------------------- | -------------------------------------------------------------------- |
| `apk_path`        | 文字列       | 両方                       | APKへの絶対パス                                                      |
| `keystore_path`   | 文字列       | 両方                       | keystoreファイルへの絶対パス                                         |
| `keystore_pass`   | 文字列       | 両方                       | keystore署名パスワード                                               |
| `keystore_alias`  | 文字列       | 両方                       | keystoreエイリアス                                                   |
| `default_tracker` | 文字列       | ストアごと                 | プリインストールをアトリビュートするためのAdjustキャンペーントークン |
