...
-  The Adjust SDK version in use is **4.35.1 or greater**.
...
3. Select the **Edit** button (<img src="//images.ctfassets.net/5s247im0esyq/3NiBS3GLm9jIsZqoQ1wkvA/d1029cd22156c5021221977a08219ca8/Edit_KPIs.png" style="display: inline-block" />) on the **Suspicious installs** section.
