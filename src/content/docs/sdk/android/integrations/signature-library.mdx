...
Using external obfuscation tools with the Adjust SDK or Signature library should be done with care as these tools can impact the functionality of the Signature library.

If in doubt, reach out to your Adjust representative or email support@adjust.com to see if functionality is impacted.
