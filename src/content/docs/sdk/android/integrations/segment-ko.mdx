...
4. 앱\([Android](https://segment.com/docs/connections/sources/catalog/libraries/mobile/android/#track)\)에서 측정할 개별 이벤트에 대한 [`track` 콜](https://segment.com/docs/connections/spec/track/)을 생성합니다.
