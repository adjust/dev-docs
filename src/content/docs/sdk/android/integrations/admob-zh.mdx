...
如果您对 AdMob 广告收入跟踪有任何疑问，请联系您的专属客户经理，或发送邮件至 [support@adjust.com](mailto:support@adjust.com)。
...
1. [Configure the Adjust SDK and integrate it in your app](/zh/sdk/android).
