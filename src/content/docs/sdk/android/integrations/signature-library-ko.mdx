...
* 사용 중인 Adjust SDK 버전이 **4\.38\.2 이상** 이어야 합니다.
...
3. 앱 수준의 `build.gradle` 파일을 열고 다음을 추가합니다.
...
4. Android Studio 팝업창에서 **Sync Now** 를 선택하여 변경 사항을 동기화합니다.
...
#### [키스토어\(keystore\)에서](from-a-keystore)
