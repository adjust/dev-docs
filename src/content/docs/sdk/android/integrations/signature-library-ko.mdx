...
-  [116KB page size aligned Signature libraries](https://developer.android.com/guide/practices/page-sizes) 에 관심이 있는 경우 Adjust 담당자 또는 [support@adjust.com](mailto:support@adjust.com) 으로 이메일 주시기 바랍니다.
