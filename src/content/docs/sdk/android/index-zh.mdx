...
通过 Adjust Meta Install Referrer 插件，Adjust SDK 可以支持[Meta](https://developers.facebook.com/docs/app-ads/meta-install-referrer) Install Referrer。[请参阅文档了解集成详情](/zh/sdk/android/plugins/meta-referrer-plugin)。

## [6\. 设置 SDK 签名](set-up-sdk-signature)

SDK v5 包含 [SDK 签名库](https://help.adjust.com/zh/article/sdk-signature)。签名保护功能默认处于禁用状态。要启用该功能，您需要：
...
-  `appToken`: Your [Adjust app token](https://help.adjust.com/zh/article/app-settings#view-your-app-token).
