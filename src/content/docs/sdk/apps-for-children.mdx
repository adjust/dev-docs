...
Google’s Families Policy suggests that apps targeted to kids should not use the `AD_ID` permission. Adjust RECOMMENDS that you:
...
1. [Set up SKAdNetwork](https://help.adjust.com/en/article/set-up-skadnetwork-in-the-adjust-sdk) in the Adjust SDK.
   ...
   -  [Flutter](/en/sdk/flutter/features/skad)
   -  [Cordova](/en/sdk/cordova/features/skad)
