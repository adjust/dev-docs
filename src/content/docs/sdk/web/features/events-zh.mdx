...
---
Adjust SDK 提供一个事件界面对象，用于架构并向 Adjust 服务器发送来自您应用的事件信息。
...
要发送事件，请调用 `Adjust.trackEvent` 方法，并以参数形式传送您的 Adjust [事件识别码](https://help.adjust.com/en/article/add-events#manage-your-events)。
