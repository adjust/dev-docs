...
<tabs> <tab title="iOS" sync="ios" icon="PlatformIos"> <codeblock title="メソッドシグネチャー"> 
...
</Tab> </Tabs> </Tab> <tab title="Android" sync="android" icon="PlatformAndroid"> <codeblock title="メソッドシグネチャー"> 
