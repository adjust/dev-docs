...
<tabs> <tab title="iOS" sync="ios" icon="PlatformIos"> <codeblock title="메서드 서명"> 
...
</Tab> </Tabs> </Tab> <tab title="Android" sync="android" icon="PlatformAndroid"> <codeblock title="메서드 서명"> 
