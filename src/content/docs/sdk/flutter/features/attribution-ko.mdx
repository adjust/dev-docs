...
slug: "ko/sdk/flutter/features/attribution"
multiVersion: true
---
...
다음 값은 [`AdjustConfig` 인스턴스의 `isCostDataInAttributionEnabled` 속성](/ko/sdk/flutter/configuration#enable-cost-data-sending)이 `true`인 경우에만 액세스할 수 있습니다.
