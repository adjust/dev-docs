...
사용자가 구독을 구매한 지역을 기록할 수 있습니다. 이를 위해 구독 객체의 `setSalesRegion` 메서드를 호출하고 국가 코드를 `String`로 전달합니다. 이는 [`Storefront`](https://developer.apple.com/documentation/storekit/storefront) 객체의 [`countryCode`](https://developer.apple.com/documentation/storekit/storefront/3792000-countrycode)로 포맷되어야 합니다.
