...
기록된 광고 노출 횟수를 전송하려면 광고 매출 인스턴스의 `adImpressionsCount` 속성에 **숫자** 값을 할당합니다.
...
광고 매출 네트워크를 전송하려면 광고 매출 인스턴스의 `adRevenueNetwork` 속성에 **문자열** 값으로 네트워크 이름을 할당합니다.
...
광고 매출 게재 단위를 전송하려면 광고 매출 인스턴스의 `adRevenueUnit` 속성에 **문자열** 값으로 단위를 할당합니다.
...
광고 매출 게재 위치를 전송하려면 광고 매출 인스턴스의 `adRevenuePlacement` 속성에 **문자열** 값으로 게재 위치를 할당합니다.
