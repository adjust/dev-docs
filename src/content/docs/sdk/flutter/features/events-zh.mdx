...
</CodeBlock> <codeblock title="事件日志" collapse="6-46"> 
...
</CodeBlock> \#\# \[添加回传标识符\]\(add\-a\-callback\-identifier\) <codeblock title="属性声明"> 
...
</CodeBlock> </CodeBlock> <codeblock title="事件日志" highlight="{range: 7}"> 
