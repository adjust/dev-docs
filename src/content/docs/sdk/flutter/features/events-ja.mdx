...
</CodeBlock> <codeblock title="イベントログ" collapse="6-46"> 
...
</CodeBlock> \#\# \[コールバックIDを追加\]\(add\-a\-callback\-identifier\) <codeblock title="プロパティ宣言"> 
...
</CodeBlock> </CodeBlock> <codeblock title="イベントログ" highlight="{range: 7}"> 
