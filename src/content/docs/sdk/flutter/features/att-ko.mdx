...
slug: "ko/sdk/flutter/features/att"
---
...
## [앱 트래킹 승인 래퍼](app-tracking-authorization-wrapper)
...
트래킹 요청 다이얼로그에 대한 텍스트 콘텐츠를 지정해야 합니다. 이를 위해 텍스트를 `Info.plist` 파일의 `NSUserTrackingUsageDescription` 키에 추가합니다.
