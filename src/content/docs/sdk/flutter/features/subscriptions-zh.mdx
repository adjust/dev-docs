...
|-----------------|------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `price`         | 数字   | 订阅价格                                                                                                                                                                                                                                                   |
| `currency`      | 字符串  | 订阅使用的币种。此信息格式为 [`priceLocale`](https://developer.apple.com/documentation/storekit/skproduct/1506145-pricelocale?language=objc) 对象的 [`currencyCode`](https://developer.apple.com/documentation/foundation/nslocale/1642836-currencycode?language=objc)。 |
...
您可以记录用户购买订阅的地区。为此，请在订阅对象上调用 `setSalesRegion` 方法并将国家代码作为 **字符串** 传递。此信息格式需为 [`priceLocale`](https://developer.apple.com/documentation/storekit/skproduct/1506145-pricelocale?language=swift) 对象 的 [`countryCode`](https://developer.apple.com/documentation/foundation/nslocale/1643060-countrycode?language=swift) 。
