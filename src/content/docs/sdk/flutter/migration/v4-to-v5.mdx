...
This setting has been removed in SDK v5 including the `checkForNewAttStatus` method. Calling this method would make SDK stop the delay and continue with its work.
...
```dart
adjustConfig.skanUpdatedCallback = (Map<String, String> skanUpdateData) {
