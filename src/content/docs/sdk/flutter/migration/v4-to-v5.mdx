...
This setting has been removed in SDK v5 including the `checkForNewAttStatus`. Calling this method would make SDK stop the delay and continue with its work.
