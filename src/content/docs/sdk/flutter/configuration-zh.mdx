...
Push tokens are used for [Audiences](https://help.adjust.com/zh/article/audiences) and client callbacks. They're also required for [Uninstall and reinstall measurement](https://help.adjust.com/zh/article/uninstalls-reinstalls).
