...
In SDK v5, deep links are opened by default. You need to call the ` disableDeferredDeeplinkOpening` method on your `adjustConfig` instance to enable the SDK to open deep links.
