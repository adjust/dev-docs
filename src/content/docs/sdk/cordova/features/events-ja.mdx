...
</Tab> </Tabs> <codeblock title="イベントログ" highlight="{range: 22-23}" collapse="7-21, 24-46"> 
...
</Tab> </Tabs> <codeblock title="イベントログ" highlight="{range: 7-8}"> 
...
この例では、ユーザーがボタンを操作する度に *`g3mfiw`* のトークンでイベントを計測する方法を示します。この関数は、 `setTransactionId`メソッドを使用して`transactionId`から *`5e85484b-1ebc-4141-aab7-25b869e54c49`* に設定します。
