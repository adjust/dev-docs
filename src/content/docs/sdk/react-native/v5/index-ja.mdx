...
SDK v5には、 [SDKシグネチャーライブラリ](https://help.adjust.com/en/article/sdk-signature)が含まれています。連携が正常に機能することを確認するためには、[iOS](/en/sdk/ios/integrations/signature-library#test-your-app)と[Android](/en/sdk/android/integrations/signature-library#test-your-app)のためのガイドを参照してください。
