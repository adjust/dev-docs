...
slug: ko/sdk/react-native/v4/features/attribution
versions:
   - label: v5
     value: v5
     default: true
   - label: v4
     value: v4
redirects:
   v5: /ko/sdk/react-native/features/attribution
---
...
다음 값은 [`AdjustConfig` 인스턴스의 `needsCost` 속성](/ko/sdk/react-native/configuration#enable-cost-data-sending)이 `true`인 경우에만 액세스할 수 있습니다.
