...
2. [React Native 문서](https://help.adjust.com/ko/article/deep-links-react-native-sdk#:~:text=React%20Native%20documentation)를 참조하고 지침에 따라 두 플랫폼을 모두 지원하는 방법을 확인합니다.
