...
2. [React Nativeのドキュメント](https://help.adjust.com/en/article/deep-links-react-native-sdk#:~:text=React%20Native%20documentation)を参照し、指示に従って、両方のプラットフォームをサポートする方法を確認します。
