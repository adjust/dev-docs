...
slug: "ko/sdk/react-native/features/privacy"
multiVersion: true
---
...
`setCoppaCompliantEnabled` 메서드를 비활성화해도 서드파티 공유는 재활성화되지 _않습니다_ . 해당 사용자에 대한 [서드파티 공유 재활성화](#third-party-sharing-for-specific-users)는 별도의 설정이 필요합니다.
