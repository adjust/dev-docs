...
2. Refer to the [React Native documentation](https://help.adjust.com/en/article/deep-links-react-native-sdk#:~:text=React%20Native%20documentation) and follow the instructions to learn how to support both platforms.
