...
[구매 검증](https://help.adjust.com/ko/article/purchase-verification)을 활성화한 경우 검증을 위해 구매 이벤트와 함께 추가 정보를 전송해야 합니다. Adjust의 서버가 이벤트 객체에서 이 정보를 수신하면, Apple 또는 Google에 전달하여 포함된 정보에 따라 구매를 검증합니다.
