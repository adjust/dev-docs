...
<apiversion version="v2"> <codeblock title="终端" highlight="v2/apps/{app_token}/trackers"> 

```http
GET https://api.adjust.com/public/v2/apps/{app_token}/trackers
```

</CodeBlock> </ApiVersion> <apiversion version="v1"> <codeblock title="终端" highlight="v1/apps/{app_token}/trackers"> 
