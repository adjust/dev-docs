...
```http title="Endpoint" "v2/apps/{app_token}/trackers/{tracker_token}/children"
...
```http title="Endpoint" "v1/apps/{app_token}/trackers/{tracker_token}/children"
GET https://api.adjust.com/public/v1/apps/{app_token}/trackers/{tracker_token}/children
```

</ApiVersion>

## [Fetch subtrackers](fetch-subtrackers)
