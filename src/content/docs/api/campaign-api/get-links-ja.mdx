---
title: "ネットワークリンクの取得"
description: "このエンドポイントを使用して、指定したアプリのネットワークレベルのリンクを取得します。"
slug: "en/api/campaign-api/get-links"
sidebar-position: 2
sidebar-label: "リンクの取得"
multiVersion: true
---
このエンドポイントを使用して、指定したアプリのネットワークレベルのリンクを取得します。
<apiversion version="v2"> <codeblock title="エンドポイント" highlight="v2/apps/{app_token}/trackers"> 

```http
GET https://api.adjust.com/public/v2/apps/{app_token}/trackers
```

</CodeBlock> </ApiVersion> <apiversion version="v1"> <codeblock title="エンドポイント" highlight="v1/apps/{app_token}/trackers"> 
