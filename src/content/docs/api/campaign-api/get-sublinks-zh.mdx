...
---
使用此终端，为指定的应用获得子链接。
<apiversion version="v2"> <codeblock title="终端" highlight="v2/apps/{app_token}/trackers/{link_token}/children"> 

```http
GET https://api.adjust.com/public/v2/apps/{app_token}/trackers/{link_token}/children
```

</CodeBlock> </ApiVersion> <apiversion version="v1"> <codeblock title="终端" highlight="v1/apps/{app_token}/trackers/{link_token}/children"> 
...
<apiversion version="v2"> <codeblock title="分页示例"> 
...
</CodeBlock> </ApiVersion> <apiversion version="v1"> <codeblock title="分页示例"> 
