...
slug: "zh/api/campaign-api/update-tracker"
sidebar-position: 5
---
...
| `tracker_token`\*   | `String`  | 路径 \(Path\) | 要更新的跟踪链接的跟踪码。                                                          |
| `partner_id`        | `Integer` | 正文          | 要附加至跟踪链接的合作伙伴的 ID。您可以使用合作伙伴终端来获取合作伙伴及其 ID 列表。 |
| `cost_data_enabled` | `Boolean` | 正文          | 是否为跟踪链接开启成本数据。                                                        |
...
| `level`             | `Integer` | 跟踪链接层级。详见下文\[跟踪链接层级\]\(tracker\-levels\)一节。 | `1`                                         |
