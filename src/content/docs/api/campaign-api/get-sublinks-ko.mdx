---
title: "하위 링크 받기"
description: "본 엔드포인트를 사용하여 지정된 앱에 대한 하위 링크를 불러오시기 바랍니다."
slug: "en/api/campaign-api/get-sublinks"
sidebar-position: 3
multiVersion: true
---
본 엔드포인트를 사용하여 지정된 앱에 대한 하위 링크를 불러오시기 바랍니다.
<apiversion version="v2"> <codeblock title="엔드포인트" highlight="v2/apps/{app_token}/trackers/{link_token}/children"> 

```http
GET https://api.adjust.com/public/v2/apps/{app_token}/trackers/{link_token}/children
```

</CodeBlock> </ApiVersion> <apiversion version="v1"> <codeblock title="엔드포인트" highlight="v1/apps/{app_token}/trackers/{link_token}/children"> 
