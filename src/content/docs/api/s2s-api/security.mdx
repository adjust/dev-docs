...
-  **GDPR**: grants the ability to send data erasure requests.
...
5. Find your token in the list and select the edit icon.
   ...
   ![A list of scoped tokens with inline edit buttons](@images/s2s/6-edit-token.png)

6. Add or remove scopes from the **Scope** dropdown.
7. Select **Edit token** to save your changes.

   ![A modal showing a token with a list of scopes](@images/s2s/7-scoped-token-edit.png)
