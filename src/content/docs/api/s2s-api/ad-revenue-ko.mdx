...
---
광고 매출을 직접 트래킹하는 경우 해당 데이터를 서버 간\(S2S\) 공유하여, Adjust가 측정하는 기타 지표와 함께 확인할 수 있습니다. 이를 통해 캠페인 퍼포먼스의 전반적인 개요 확인, 사용자 생애 가치\(LTV\) 계산, 캠페인의 ROAS 또는 ROI 최적화가 가능합니다.
