...
-  [Admin permissions](https://help.adjust.com/ko/article/permission-levels)
...
At this point, S2S authentication isn't active and requests carrying invalid tokens are still accepted. Speak to your dedicated Technical Account Manager or contact [support@adjust.com](mailto:support@adjust.com) to validate the setup before activating S2S authentication.
...
Activate S2S authentication only after your developer has tested token implementation, and your Technical Account Manager or [support@adjust.com](mailto:support@adjust.com) has validated your setup.
