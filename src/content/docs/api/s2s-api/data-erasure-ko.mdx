...
사용자가 삭제 요청을 보낼 때 이 API 엔드포인트로 요청을 보내도록 서버를 구성합니다. 삭제 요청에 대한 자세한 내용은 [관련 페이지](https://help.adjust.com/en/article/gdpr)를 참조하시기 바랍니다.
<callout type="important"> 

이 작업은 **영구적** 입니다. 삭제 요청이 전송되면 Adjust는 이전에 기기와 관련되었던 데이터를 복구하거나 향후 요청을 수신할 수 없습니다.
</Callout> <codeblock title="엔드포인트" highlight="/gdpr_forget_device"> 
