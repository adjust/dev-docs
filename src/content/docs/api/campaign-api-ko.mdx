...
<tabs> <tab title="v2" sync="v2"> <codeblock title="엔드포인트" highlight="v2/apps/{app_token}/trackers"> 

```http
GET https://api.adjust.com/public/v2/apps/{app_token}/trackers
```

</CodeBlock> </Tab> <tab title="v1" sync="v1"> <codeblock title="엔드포인트" highlight="v1/apps/{app_token}/trackers"> 
...
:  [앱을 식별하는 영숫자 토큰](https://help.adjust.com/en/article/app-token-and-reporting-currency#view-your-app-details). 반드시 12자여야 합니다.
...
</CodeBlock> </Tab> <tab title="v1" sync="v1"> <codeblock title="cURL" highlight="gwzpeepw8uf8"> 
...
<tabs> <tab title="v2" sync="v2"> <codeblock title="엔드포인트" highlight="v2/apps/{app_token}/trackers/{link_token}/children"> 

```http
GET https://api.adjust.com/public/v2/apps/{app_token}/trackers/{link_token}/children
```

</CodeBlock> </Tab> <tab title="v1" sync="v1"> <codeblock title="엔드포인트" highlight="v1/apps/{app_token}/trackers/{link_token}/children"> 
...
</CodeBlock> </Tab> <tab title="v1" sync="v1"> <codeblock title="cURL" highlight="gwzpeepw8uf8, abc123"> 
