...
-  사용자가 RTBF 요청 전송 시 해당 API 엔드포인트에 요청을 전달하도록 서버를 구성합니다. RTBF 요청에 관한 자세한 정보는 Adjust의 [GDPR 관련 자료](https://help.adjust.com/ko/article/gdpr)를 참조하시기 바랍니다.
