...
### [Adjustを使用してCPMを計測](measure-cpm-with-adjust)
...
: 広告費用情報の通貨コード。[ISO 4217](https://www.iban.com/currency-codes)の通貨コードでフォーマットされなければなりません。Adjustがサポートしている[全ての通貨のリスト](https://help.adjust.com/en/article/supported-currencies)をご覧ください。
...
テストが完了すると、Adjustは連携された[広告費用パートナーのリスト](https://help.adjust.com/en/article/ad-spend-api-integrations#supported-partners)にお客様を追加します。
