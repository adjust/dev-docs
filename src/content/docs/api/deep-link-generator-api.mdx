...
-  Links created using the Deep link generator API are not displayed in [Campaign Lab](https://help.adjust.com/en/article/campaign-setup).
...
| `shorten_url`            | Bool           | Body   | Whether the link will be shortened. The link isn't shortened by default. Default value - false                                                                                                                    |
...
Use the POST request to generate either a long or a short deep link for single or multi-platform apps.
...
Use the POST request to generate either long or a short deep links for single or multi-platform apps, in bulk.
...
Use the PUT request to update an existing short link token in a deep link to a long link.
