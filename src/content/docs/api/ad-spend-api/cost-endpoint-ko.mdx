...
| `cost_currency`\* | String | Query | [ISO 4217](https://www.iban.com/currency-codes) 통화 코드. [지원되는 통화 목록](https://help.adjust.com/resources/lists/supported-currencies)을 참조하시기 바랍니다. |
