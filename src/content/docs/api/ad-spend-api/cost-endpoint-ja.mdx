...
| `cost_currency`\* | `String` | クエリ   | [ISO 4217](https://www.iban.com/currency-codes)の通貨コード。Adjustがサポートしている[全ての通貨のリスト](https://help.adjust.com/en/article/supported-currencies)をご覧ください。 |
...
</Callout> <codeblock title="cURL" highlight="cost_type, cost_currency, cost_amount, cost_id, tag"> 
