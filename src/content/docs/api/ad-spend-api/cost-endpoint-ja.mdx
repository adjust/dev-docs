...
| `cost_currency`\* | `String` | クエリ   | [ISO 4217](https://www.iban.com/currency-codes)の通貨コード。Adjustがサポートしている[全ての通貨のリスト](https://help.adjust.com/resources/lists/supported-currencies)をご覧ください。 |
