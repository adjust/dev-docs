...
## [Adjustと連携してCPMを計測する](tracking-cpm-with-adjust)

AdjustにCPM（1000回表示あたりの広告費）データを送信するには、インプレッショントラッカーURLで`cost_id`を送信し、広告費用APIコールで参照します。インプレッションごとにCPMを送信してください。
