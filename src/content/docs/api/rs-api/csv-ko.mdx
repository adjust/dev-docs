...
| `reattributed`                 | `String`  | 리어트리뷰션된 사용자만 필터링. 리어트리뷰션은 이미 앱을 설치한 이력이 있는 유저가 Adjust에 트래킹된 새로운 소스를 통해 앱으로 복귀한 경우입니다.<ul><li>`all` \(기본값\)</li><li>`false`</li><li>`true`</li></ul>      | `reattributed=false`                                                                                                                                                                                                                                                                                                                                  |
...
| `campaign`            | `String` | 트래커 하위 레벨 1\. 문자열 값은 일반적으로 캠페인 이름과 ID 포함.                                                                                                                                                                                         |                                                           |
| `campaign_network`    | `String` | 네트워크로부터의 캠페인 이름.                                                                                                                                                                                                                   |                                                           |
| `campaign_id_network` | `String` | 네트워크로부터의 캠페인 ID.                                                                                                                                                                                                                   |                                                           |
| `adgroup`             | `String` | 트래커 하위 레벨 2\. 문자열 값은 일반적으로 광고그룹 이름과 ID 포함.                                                                                                                                                                                        |                                                           |
...
| `creative`            | `String` | 트래커 하위 레벨 3\. 문자열 값은 일반적으로 크리에이티브 이름과 ID 포함.                                                                                                                                                                                      |                                                           |
...
Adjust를 통해 진행하고 트래킹하는 캠페인의 퍼포먼스를 평가 및 비교하기 위해 지표가 사용됩니다.
