...
읽을 수 있는\(human\-readable\) 이름은 업스트림 요청에 따라 달라질 수 있습니다. 일관성을 위해 장기 캠페인에 대한 리포트의 경우 슬러그를 사용하시기 바랍니다. 이벤트 슬러그는 [이벤트 엔드포인트](/ko/api/rs-api/events)를 사용하여 조회할 수 있습니다.
