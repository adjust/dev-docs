...
<codeblock title="엔드포인트" highlight="/reports-service/csv_report"> 
...
| `iap_revenue_mode`             | `String`  | 엔드포인트에 의해 반환된 총 광고 매출의 퍼센트. 선택 가능한 옵션은 다음과 같습니다.<ul><li>`GROSS_100`</li><li>`GROSS_85`</li><li>`GROSS_70`</li><li>`GROSS_60`</li></ul>                     | `iap_revenue_mode=GROSS_70`                                                                                                                                                                                                                                                                                                                           |
