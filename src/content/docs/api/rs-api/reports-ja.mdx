...
[JSONレポートの取得](fetch-json-report)
--------------------------------

<codeblock title="エンドポイント" highlight="/reports-service/report"> 
...
| `reattributed`                 | `String`  | Filter for reattributed users only. Reattribution is when a user who has already installed your app returns to it through a new Adjust\-measured source.<ul><li>`all` \(デフォルト\)</li><li>`false`</li><li>`true`</li></ul> | `reattributed=false`                                                                                                                                                                                                                                                                                                                            |
