...
| `reattributed`                 | `String`  | リアトリビュートされたユーザーのみをフィルタリングします。リアトリビューションは、アプリをインストール済みのユーザーが、Adjustが計測する新しいソースを経由して戻ってきた場合に計測されます。<ul><li>`all` \(デフォルト\)</li><li>`false`</li><li>`true`</li></ul> | `reattributed=false`                                                                                                                                                                                                                                                                                                                            |
