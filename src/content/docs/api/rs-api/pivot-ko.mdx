...
| `reattributed`                 | `String`  | Filter for reattributed users only. Reattribution is when a user who has already installed your app returns to it through a new Adjust\-measured source.<ul><li>`all` \(기본값\)</li><li>`false`</li><li>`true`</li></ul> | `reattributed=false`                                                                                                                                                                                                                                                                                                                                  |
