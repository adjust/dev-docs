...
| `reattributed`                 | `String`  | Filter for reattributed users only. Reattribution is when a user who has already installed your app returns to it through a new Adjust\-measureed source.<ul><li>`all` \(デフォルト\)</li><li>`false`</li><li>`true`</li></ul> | `reattributed=false`                                                                                                                                                                                                                                                                                                                            |
| `ad_revenue_mode`              | `String`  | エンドポイントが返した総計広告収益の割合。 利用可能なオプションは以下のとおりです：<ul><li>`GROSS_100`</li><li>`GROSS_85`</li><li>`GROSS_70`</li><li>`GROSS_60`</li></ul>                                                                                             | `ad_revenue_mode=GROSS_70`                                                                                                                                                                                                                                                                                                                      |
...
| `quarter`             | `String` | 値をISO形式で返す場合は`format_dates=false`を使用します。 `Q<quarter_number id="sl-md0000000"> YYYY`                                                                                                                                                 | `Q2 2021`                                               |
