...
[ピボットレポートの取得](fetch-pivot-report)
---------------------------------
...
| `focus`                        | `String`  | フォーカスするパラメーターのリスト。 パイプで区切られたタプルとしてフォーマットされます。 結果にさらなるディメンションを追加しないため、ドリルダウンとは異なります。                                                                                                                                         | `focus=campaign:123\|adgroup:234`                                                                                                                                                                                                                                                                                                              |
