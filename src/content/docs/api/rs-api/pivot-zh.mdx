...
[调取透视报告](fetch-pivot-report)
----------------------------

<codeblock title="终端" highlight="/reports-service/pivot_report"> 
...
| `reattributed`                 | `String`  | Filter for reattributed users only. Reattribution is when a user who has already installed your app returns to it through a new Adjust\-measured source.<ul><li>`all` \(默认\)</li><li>`false`</li><li>`true`</li></ul> | `reattributed=false`                                                                                                                                                                                                                                                                                                                            |
| `ad_revenue_mode`              | `String`  | 终端返回的广告总收入百分比。可选项包括：<ul><li>`GROSS_100`</li><li>`GROSS_85`</li><li>`GROSS_70`</li><li>`GROSS_60`</li></ul>                                                                                                               | `ad_revenue_mode=GROSS_70`                                                                                                                                                                                                                                                                                                                      |
...
| `drilldown`                    | `String`  | 细分数据所用的参数列表。格式：用竖线 \(\|\) 隔开的元组。                                                                                                                                                                                       | `drilldown=campaign:123\|adgroup:234`                                                                                                                                                                                                                                                                                                          |
| `focus`                        | `String`  | 聚焦所用参数列表。格式为用竖线 \(\|\) 隔开的元组。与 drilldown 不同，不会向结果添加额外维度。                                                                                                                                                               | `focus=campaign:123\|adgroup:234`                                                                                                                                                                                                                                                                                                              |
