...
[기기 삭제](#forget-device)는 **파괴적인\(destructive\)** 행동입니다. 기기 삭제 엔드포인트를 사용하려면 반드시 계정에 다음 [사용자 권한](https://help.adjust.com/en/article/users) 중 **하나** 가 있어야 합니다.
...
<tabs> <tab title="v2" sync="v2"> <codeblock title="엔드포인트"> 

```http
GET https://api.adjust.com/device_service/api/v2/inspect_device
```

</CodeBlock> </Tab> <tab title="v1" sync="v1"> <codeblock title="엔드포인트"> 
