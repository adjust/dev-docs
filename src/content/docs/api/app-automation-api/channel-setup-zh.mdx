...
如果您向模板应用中添加了合作伙伴设置，API 不会默认复制这些设置。您需要在 [`/app` POST 调用](/en/api/app-automation-api/app-endpoint#parameters)中填充对应参数，才能填充这些设置。
...
1. 使用 [`/app` POST 终端](/en/api/app-automation-api/app-endpoint#parameters) 创建应用。
