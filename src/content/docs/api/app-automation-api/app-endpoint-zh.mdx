...
|            参数            |   数据类型    | 位置 |                                      描述                                      |
|--------------------------|-----------|----|------------------------------------------------------------------------------|
| `store_id`\*            | `String`  | 正文 | Bundle ID \(Android\) \| Store ID \(Apple\)                              |
| `platform`\*            | `String`  | 正文 | `android` \| `ios`                                                           |
| `name`\*                | `String`  | 正文 | 应用的名称。                                                                       |
| `bundle_id`\*           | `String`  | 正文 | 您应用的 Bundle ID。                                                              |
| `android_signature_hash` | `String`  | 正文 | 从 keystore 文件中生成的 SHA1 哈希，用来创建 SDK 签名。                                       |
| `channel_setup`          | `Object`  | 正文 | 应用合作伙伴模块设置所必需。请参阅[渠道源设置一文](/en/api/app-automation-api/channel-setup)，了解更多信息。 |
| `editors`                | `String`  | 正文 | 应拥有应用访问权限的用户邮箱列表。                                                            |
| `template_app_token`     | `String`  | 正文 | 作为模板的 Adjust 应用识别码。如果您不使用模板，则该识别码为必需。                                        |
| `force_update`           | `Boolean` | 正文 | 发送该值为 true，以更新现有应用设置。                                                        |
...
| `ticket_token`     | `String<uuid id="sl-md0000000">` | Ticket ID，用来查看当前工作状态。请参阅[状态终端文档](/en/api/app-automation-api/status-endpoint)，了解更多信息。 |
...
|     参数     |                数据类型                |        描述        |
|------------|------------------------------------|------------------|
| `channels` | `Array <string id="sl-md0000000">` | 该应用活跃途径的渠道 slug。 |
