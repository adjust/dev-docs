...
| `channel_setup`          | `Object`  | 正文 | 应用合作伙伴模块设置所必需。请参阅[渠道源设置一文](/zh/api/app-automation-api/channel-setup)，了解更多信息。 |
...
| `ticket_token`     | `String<uuid id="sl-md0000000">` | Ticket ID，用来查看当前工作状态。请参阅[状态终端文档](/zh/api/app-automation-api/status-endpoint)，了解更多信息。 |
