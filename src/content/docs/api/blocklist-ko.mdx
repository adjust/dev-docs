...
Adjust 차단 리스트 API를 사용하면 허위 또는 만료된 링크로부터의 트래픽을 차단할 수 있습니다. 커스텀 링크와 파트너 링크를 차단 리스트에 추가할 수 있습니다. 자기 기여 네트워크\(SAN\) 파트너 링크는 차단 리스트에 추가할 수 없습니다. SAN 파트너 링크로부터의 트래픽을 차단하려면 반드시 SAN 파트너를 삭제해야 합니다. SAN 파트너 목록은 [셀프 어트리뷰션 네트워크 설정](https://help.adjust.com/en/suite/article/self-attributing-network-san-setup) 페이지를 참고하시기 바랍니다.
...
[Campaign Lab](https://help.adjust.com/en/article/campaign-setup)에서 차단 리스트에 추가된 링크를 확인할 수 있습니다. 이를 위해 다음을 수행하시기 바랍니다.

1. Campaign Lab으로 이동합니다.
2. 파트너를 선택하면 관련 링크 목록이 표시됩니다. 차단 리스트에 있는 링크는 **차단 리스트에 등록됨** 으로 표시됩니다.

Campaign Lab에서 차단 리스트에 등록된 링크를 숨길 수 있습니다. 자세한 내용은 [Campaign Lab에서 숨겨진 링크](https://help.adjust.com/en/article/manage-ad-network-setup#hidden-links)를 참조하시기 바랍니다.
