...
: The [cursor position](#fetch-partners-pagination) from which to start your request.

`before` (`String`)

: The [cursor position](#fetch-partners-pagination) at which to end your request.
...
Each results page contains a `paging` object containing the cursor positions. You can use these cursor positions to programatically move between pages. For example, the first page might contain the following `paging` object:
...
Results from this endpoint are paginated using a cursor. Each results page contains a `paging` object containing cursor positions. You can use these cursor positions to programatically move between pages. For example, the first page might contain results like this:
...
: The [cursor position](#fetch-sublinks-pagination) from which to start your request.

`before` (`String`)

: The [cursor position](#fetch-sublinks-pagination) at which to end your request.
