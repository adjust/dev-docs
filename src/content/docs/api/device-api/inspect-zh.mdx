---
title: "查询设备终端"
description: "使用查询设备终端来查看设备信息。提供您的应用 ID 和设备的广告 ID，返回与应用相关的设备和跟踪链接。"
slug: "en/api/device-api/inspect"
sidebar-position: 2
---
使用查询设备终端来查看设备信息。提供您的应用 ID 和设备的广告 ID，返回与应用相关的设备和跟踪链接。
...
|         参数          | 数据类型 | 位置 |                     描述                     |
|---------------------|------|----|--------------------------------------------|
| `app_token`\*      | 字符串  | 查询 | 应用的 12 位数标识符                               |
| `advertising_id`\* | 字符串  | 查询 | 设备的唯一广告 ID。请查看下方[广告 ID](#advertising-ids)。 |
