---
title: "디바이스 엔드포인트 검사"
description: "디바이스 엔드포인트 검사(inspect device endpoint)를 사용하면 기기에 대한 정보를 확인할 수 있습니다. 앱 관련 기기 및 트래커 정보를 반환하기 위해 앱 ID 및 기기의 광고 ID를 입력하시기 바랍니다."
slug: "ko/api/device-api/inspect"
sidebar-position: 2
---

디바이스 엔드포인트 검사\(inspect device endpoint\)를 사용하면 기기에 대한 정보를 확인할 수 있습니다. 앱 관련 기기 및 트래커 정보를 반환하기 위해 앱 ID 및 기기의 광고 ID를 입력하시기 바랍니다.
