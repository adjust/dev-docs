...
description: "The Partner ad spend API allows you to send ad spend information associated with a campaign."
category-title: Partner ad spend API
slug: en/api/ad-spend-api
sidebar-position: 2
---

The Partner ad spend API allows you to send ad spend information associated with a campaign. Adjust accepts ad spend data for an engagement **up to seven days** after the engagement occurs.
...
The following parameters MUST be sent in the **query parameters** of your API call. All parameters MUST be sent in **lowercase**.
