...
: 广告支出信息的货币代码。必须采用 [ISO 4217](https://www.iban.com/currency-codes) 货币代码格式。请参阅我们[支持币种的完整清单](https://help.adjust.com/en/article/supported-currencies)。
...
测试完成后，Adjust 会将您添加至[集成广告支出合作伙伴列表](https://help.adjust.com/en/article/ad-spend-api-integrations#supported-partners)。
