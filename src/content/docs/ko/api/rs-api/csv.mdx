...
전체 지표 목록은 [Datascape 지표 용어집](https://help.adjust.com/en/article/datascape-metrics-glossary)을 참고하시기 바랍니다. [필터 데이터 엔드포인트](/en/api/rs-api/filters-data)를 사용하여 KPI를 검색할 수도 있습니다. 
