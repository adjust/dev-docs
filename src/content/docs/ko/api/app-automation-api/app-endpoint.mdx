...
| `channel_setup`          | `Object`  | Body | 앱에 대한 파트너 모듈 설정을 위해 필요. 자세한 정보는 [채널 설정 설명](/en/api/app-automation-api/channel-setup)을 참고하시기 바랍니다. |
...
1. 다음 정보와 함께 POST 요청을 `/app` 엔드포인트로 전송합니다.
   ...
   * `channel_setup`: 앱에 대한 파트너 모듈 설정을 위해 필요. 자세한 정보는 [채널 설정 페이지](/en/api/app-automation-api/channel-setup/)를 참고하시기 바랍니다. 
