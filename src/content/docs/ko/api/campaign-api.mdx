...
<Tabs>
<Tab title="v2" sync="v2"> <CodeBlock title="엔드포인트" highlight="/partners">
...
<Tabs>
<Tab title="v2" sync="v2"> <CodeBlock title="엔드포인트" highlight="v2/apps/{app_token}/trackers">
...
<Tabs>
<Tab title="v2" sync="v2"> <CodeBlock title="엔드포인트" highlight="v2/apps/{app_token}/trackers/{link_token}/children">
...
<Tabs>
<Tab title="v2" sync="v2"> <CodeBlock title="엔드포인트" highlight="{app_token}/trackers">
...
</Tab> </Tabs> ## 링크 업데이트 {#update-links} <Tabs>
<Tab title="v2" sync="v2"> <CodeBlock title="엔드포인트" highlight="{app_token}/trackers/{link_token}">
