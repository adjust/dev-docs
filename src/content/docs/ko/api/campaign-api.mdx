...
<tabs> <tab title="v2" sync="v2"> <codeblock title="엔드포인트" highlight="/partners"> 
...
: [앱을 식별하는 영숫자 토큰](https://help.adjust.com/en/article/app-token-and-reporting-currency#view-your-app-details)입니다. 반드시 12자여야 합니다.
...
<tabs> <tab title="v2" sync="v2"> <codeblock title="엔드포인트" highlight="{app_token}/trackers"> 
...
</CodeBlock> </Tab> </Tabs> ## 링크 업데이트 {#update-links} <tabs> <tab title="v2" sync="v2"> <codeblock title="엔드포인트" highlight="{app_token}/trackers/{link_token}"> 
