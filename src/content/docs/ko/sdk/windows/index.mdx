...
config 객체와 초기화 로직을 추가하고 나면 Adjust SDK를 설정해 앱의 다양한 부분에 대한 정보를 기록할 수 있습니다. SDK [설정](/en/sdk/windows/configuration) 및 [기능](/en/sdk/windows/features)에 대한 안내를 확인하고 기록하고 싶은 내용을 정확히 설정해 보십시오.
