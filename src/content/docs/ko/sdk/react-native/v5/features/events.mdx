...
versions: 
    ...
    - 
        ...
        value: "v4"
redirects: 
    v4: "/en/sdk/react-native/v4/features/events"
---
...
### 중복 제거 ID 한도 설정 \{\#set\-a\-deduplication\-limit\}
...
사용자는 중복 이벤트 식별을 위해 목록에 추가할 수 있는 중복 제거 ID 개수의 한도를 맞춤 설정할 수 있습니다. 기본 설정 값은 10입니다.

한도를 설정하려면 `setEventDeduplicationIdsMaxSize` 메서드를 호출하고, 새로운 한도를 `number` 인수로 전달합니다.
