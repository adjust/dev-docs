...
slug: "en/sdk/react-native/v4/features/session-parameters"
versions: 
    - 
        label: "v5"
        value: "v5"
    ...
    - 
        ...
        value: "v4"
redirects: 
    v5: "/en/sdk/react-native/features/session-parameters"
---
...
### 세션 콜백 파라미터 재설정 \{\#reset\-session\-callback\-parameters\}
...
### 세션 파트너 파라미터 재설정 \{\#reset\-session\-partner\-parameters\}
