...
<Tabs>
<Tab title="App Store" icon="StoreAppStore" sync="appstore"> <CodeBlock title="메서드 서명">
...
<Tab title="Google Play" icon="PlatformGooglePlay" sync="playstore"> <CodeBlock title="메서드 서명">
