...
versions: 
    ...
    - 
        ...
        value: "v4"
redirects: 
    v4: "/en/sdk/android/v4/setup/preinstalled"
---
Adjust SDK를 사용하여 사용자의 기기에 사전 설치된 앱의 활동을 기록할 수 있습니다. 이 방법으로 캠페인을 통해 앱을 다운로드하지 않은 사용자의 정보를 전송할 수 있습니다.

config 객체에는 해당 기능을 제어하는 `Boolean` `preinstallTrackingEnabled` 속성이 포함되어 있습니다. 사전 설치 측정을 활성화하려면 `enablePreinstallTracking` 메서드를 호출합니다.
