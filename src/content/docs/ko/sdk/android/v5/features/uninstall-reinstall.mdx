...
versions: 
    ...
    - 
        ...
        value: "v4"
redirects: 
    v4: "/en/sdk/android/v4/features/uninstall-reinstall"
---
...
삭제 및 재설치 측정을 테스트하려면 디버그 빌드 또는 릴리스 빌드를 사용할 수 있습니다. 설치 테스트 시에는 Adjust SDK 환경을 *프로덕션* 으로 설정해야 함을 반드시 유의하시기 바랍니다. 
