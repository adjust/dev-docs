...
slug: "en/sdk/android/integrations/tradplus"
versions: 
    - 
        label: "v5"
        value: "v5"
    ...
    - 
        ...
        value: "v4"
redirects: 
    v4: "/en/sdk/android/v4/integrations/tradplus"
---
...
앱에 Adjust SDK를 연동하려면 [연동 가이드](/en/sdk/android)를 참조하시기 바랍니다.

예 \{\#example\}
------------------

Adjust에서 광고 수익 정보를 기록하려면, `TradPlusSdk.setGlobalImpressionListener` 함수 안에 `AdjustAdRevenue` 인스턴스를 생성하세요. 자세한 내용은 [광고 수익 정보 전송 가이드](/en/sdk/android/features/ad-revenue)를 참고하세요.
