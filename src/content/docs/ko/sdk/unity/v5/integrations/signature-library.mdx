...
본 페이지는 Adjust SDK v5의 연동 단계를 설명합니다. Adjust SDK v4를 사용하는 경우, 왼쪽의 드롭다운 메뉴에서 해당 탭을 선택하시기 바랍니다.
</Callout> 
...
[EDM4U\(External Dependency Manager for Unity\)](https://github.com/googlesamples/unity-jar-resolver)를 사용하는 경우 이 단계를 건너뛸 수 있습니다.
</Callout> 

다음 단계에 따라 Unity 프로젝트에서 서명 라이브러리를 연동합니다.

1. GitHub에서 [최신 Stable](https://github.com/adjust/adjust_signature_sdk/releases/latest) 또는 [베타](https://github.com/adjust/adjust_signature_sdk/releases) 버전을 가져옵니다.
