...
<Tabs>
<Tab title="App Store" sync="appstore" icon="PlatformIos"> <CodeBlock title="속성 선언">
...
<Tab title="Play Store" sync="playstore" icon="PlatformGooglePlay"> <CodeBlock title="속성 선언">
