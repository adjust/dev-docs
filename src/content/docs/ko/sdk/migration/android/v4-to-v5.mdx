...
SDK v4에서는 `AdjustConfig` 인스턴스의 `setPlayStoreKidsAppEnabled` 메서드를 부울 인수로 호출하여 앱을 [Play Store Kids 앱](/ko/sdk/android/features/privacy#play-store-kids-apps) 으로 표시할 수 있습니다.
