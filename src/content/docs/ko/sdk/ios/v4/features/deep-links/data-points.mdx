...
ID 형식은 `<app_id_prefix id="sl-md0000000">.<bundle_id id="sl-md0000000">`입니다. 예: `ABC1234567.com.example.app`
...
링크 해석\(link resolution\) 도메인은 이메일, SMS, QR 코드 또는 링크 단축 플랫폼을 통한 딥링크에 필요합니다. 마케팅팀과 확인하여 앱에 [링크 해석](https://help.adjust.com/en/article/link-resolution)이 필요한지 확인하시기 바랍니다.
</Callout> 
