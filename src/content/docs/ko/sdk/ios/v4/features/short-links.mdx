...
slug: "en/sdk/ios/v4/features/short-links"
versions: 
    - 
        label: "v5"
        value: "v5"
    ...
    - 
        ...
        value: "v4"
redirects: 
    v5: "/en/sdk/ios/features/short-links"
---
...
Adjust의 링크 단축 솔루션을 사용하기 위해 LinkMe 또는 [Link 해석](/en/sdk/ios/features/deep-links/resolution)\(resolution\)을 설정할 필요는 없습니다.
</Callout> 
