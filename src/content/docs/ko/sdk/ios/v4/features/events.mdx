...
slug: ko/sdk/ios/v4/features/events
versions:
   - label: v5
     value: v5
     default: true
   ...
   <body>
      ...
      <div id="sl-buttons">
         <div style="width:300px;height:35px;text-align:center;">
            <button id="sl-btnRecordDeduplicatedEvent">
               Record simple event
            </button>
         </div>
      </div>
...
</Tabs> <CodeBlock title="이벤트 로그" collapse="6-40">
...
<html>
   <body>
      ...
      <div id="sl-buttons">
         <div style="width:300px;height:35px;text-align:center;">
            <button id="sl-btnRecordRevenueEvent">Record revenue event</button>
         </div>
      </div>
   </body>
</html>
...
</Tabs> <CodeBlock title="이벤트 로그" highlight="{range: 7}">
...
<Tab title="Objective-C" sync="objc"> <CodeBlock title="ViewControllerObjC.m">
...
<html>
   <body>
      ...
      <div id="sl-buttons">
         <div style="width:300px;height:35px;text-align:center;">
            <button id="sl-btnRecordCallbackEvent">
...
<html>
   <body>
      ...
      <div id="sl-buttons">
         <div style="width:300px;height:35px;text-align:center;">
            <button id="sl-btnRecordPartnerParamsEvent">
...
</Tabs> <CodeBlock title="이벤트 로그" highlight="{range: 4}">
...
<html>
   <body>
      ...
      <div id="sl-buttons">
         <div style="width:300px;height:35px;text-align:center;">
            <button id="sl-btnRecordCallbackIdEvent">
