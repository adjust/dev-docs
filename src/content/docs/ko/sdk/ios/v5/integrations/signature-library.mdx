...
</Tab> <tab title="Swift 패키지 매니저" sync="swift-package-manager"> <callout type="important"> 
...
2. 창이 뜨면 서명의 GitHub 주소[\(https://github.com/adjust/adjust\_signature\_sdk\)를 입력합니다.](https://github.com/adjust/adjust_signature_sdk)
