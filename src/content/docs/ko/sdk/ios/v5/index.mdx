...
SDK v5는 [SDK Signature 라이브러리](https://help.adjust.com/ko/article/sdk-signature)를 포함합니다. [테스트 가이드](/ko/sdk/ios/integrations/signature-library#test-your-app)를 참조하여 연동이 잘 작동하는지 확인하시기 바랍니다.
