...
config 객체와 초기화 로직을 추가하고 나면 Adjust SDK를 설정해 앱의 다양한 부분에 대한 정보를 기록할 수 있습니다. [구성 참조](/en/sdk/ios/configuration) 및 [기능 가이드](/en/sdk/ios/features)를 확인하여 기록할 항목을 정확히 설정합니다.
