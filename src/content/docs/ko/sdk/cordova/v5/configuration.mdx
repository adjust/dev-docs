...
비즈니스 애널리틱스에서 외부 기기 ID를 사용하려면 이를 [글로벌 콜백 파라미터](/ko/sdk/cordova/features/session-parameters)로 전송해야 합니다.
...
광고 비용 데이터는 사용자의 [어트리뷰션 정보](/ko/sdk/cordova/features/attribution)에서 액세스할 수 있습니다.
