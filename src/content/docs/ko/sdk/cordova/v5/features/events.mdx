...
</CodeBlock> <codeblock title="이벤트 로그" highlight="{range: 22-23}" collapse="7-21, 24-46"> 
...
본 예시에서는 사용자가 버튼을 조작할 때마다 *`g3mfiw`* 라는 토큰으로 이벤트를 기록하는 방법을 보여줍니다. 이 함수는 `setDeduplicationId` 메서드를 사용하여 `deduplicationId`를 *`5e85484b-1ebc-4141-aab7-25b869e54c49`* 로 설정합니다.
