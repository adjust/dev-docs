...
<Tabs>
<Tab title="v2" sync="v2"> <CodeBlock title="终端" highlight="/partners">
...
<Tabs>
<Tab title="v2" sync="v2"> <CodeBlock title="终端" highlight="v2/apps/{app_token}/trackers">
...
<Tabs>
<Tab title="v2" sync="v2"> <CodeBlock title="终端" highlight="v2/apps/{app_token}/trackers/{link_token}/children">
...
<Tabs>
<Tab title="v2" sync="v2"> <CodeBlock title="终端" highlight="{app_token}/trackers">
...
</Tab> </Tabs> ## 更新链接 {#update-links} <Tabs>
<Tab title="v2" sync="v2"> <CodeBlock title="终端" highlight="{app_token}/trackers/{link_token}">
