---
title: Adjust 自动化 API 认证
description: 要使用 Adjust 自动化 API，您需要持有 bearer token。
slug: zh/api/app-automation-api/authentication
sidebar-position: 1
sidebar-label: 认证
---

要使用 Adjust 自动化 API，您需要持有 [bearer token](https://developer.mozilla.org/en-US/docs/Web/HTTP/Authentication)。您可以按照本文中的步骤在 Adjust 控制面板中获取此信息。
