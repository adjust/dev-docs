...
只有在 `AdjustConfig2dx` 实例上[调用 `enableCostDataInAttribution` 方法](/en/sdk/cocos2dx/configuration#receive-ad-spend-data)后，才能访问以下值：
...
| `clickLabel`        | `std::string` | 用于标记安装的[点击标签](https://help.adjust.com/en/article/user-rewards)                               |
