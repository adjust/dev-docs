...
请在帮助中心查看 [COPPA 合规](https://help.adjust.com/en/article/coppa-compliance)一文，了解您的应用是否需要符合 COPPA 规定。
</Callout> 
...
如果您在 Adjust 控制面板中启用了[数据隐私设置](https://help.adjust.com/en/article/manage-data-collection-and-retention)，那么则需要对 Adjust SDK 做出相应设置。这包括设置许可有效期和用户数据留存期。
