...
3. Adjust 在 [Datascape](https://help.adjust.com/en/suite/article/datascape) 和 [Data Canvas](https://help.adjust.com/en/classic/article/data-canvas-classic)中展示 SKAN 数据。
