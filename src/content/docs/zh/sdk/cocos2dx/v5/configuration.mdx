...
: 您的 [Adjust 应用识别码](https://help.adjust.com/en/article/app-token-and-reporting-currency#view-your-app-details)。
...
: 用于记录预安装应用安装的 [Adjust 链接识别码](https://help.adjust.com/en/article/links#adjust-link-token)。
</DefList> 
