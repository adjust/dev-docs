...
slug: zh/sdk/react-native/v4/features/purchase-verification
versions:
   - label: v5
     value: v5
     default: true
   - label: v4
     value: v4
redirects:
   v5: /zh/sdk/react-native/features/purchase-verification
---
...
请参阅[发送事件信息](/zh/sdk/react-native/features/events)了解有关`AdjustEvent`类的更多信息。
