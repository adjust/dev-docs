...
<Tabs>
<Tab title="Kotlin" sync="kotlin"> <CodeBlock useDiffSyntax>
...
<Tabs>
<Tab title="Kotlin" sync="kotlin"> <CodeBlock title="Google Play 应用商店 referrer">
...
<Tabs>
<Tab title="Kotlin" sync="kotlin"> <CodeBlock title="Google Play ADID getter">
...
<Tabs>
<Tab title="Kotlin" sync="kotlin"> <CodeBlock highlight="{range: 2}">
