...
2. 将下列参数以[会话合作伙伴参数](/en/sdk/ios/features/session-parameters)形式发送至 Adjust SDK。只有[延迟 SDK 启动](/en/sdk/ios/configuration#delay-the-start-of-the-sdk)后，这些参数才会在安装或会话开始时可用。 
