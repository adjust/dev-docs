...
slug: zh/sdk/ios/v4/features/events
versions:
   - label: v5
     value: v5
     default: true
...
</Tabs> <CodeBlock title="事件日志" collapse="6-40">
...
</Tabs> <CodeBlock title="事件日志" highlight="{range: 4}">
