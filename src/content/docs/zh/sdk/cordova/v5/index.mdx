...
-  [华为 Referrer API](/zh/sdk/android/plugins/huawei-referrer-plugin)
-  [Meta Install Referrer](/zh/sdk/android/plugins/meta-referrer-plugin)
...
SDK v5 包含 [SDK 签名库](https://help.adjust.com/zh/article/sdk-signature)。请按照[iOS](/zh/sdk/ios/integrations/signature-library#test-your-app)和[安卓](/zh/sdk/android/integrations/signature-library#test-your-app)测试指南操作，确保集成正确运行。
