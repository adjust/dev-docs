...
要更新签名库，请用新版本替换现有的签名库，然后重新运行测试。您无需立即在 Adjust 中对应用逻辑或设置进行变更。[如果密钥 ID 满足以下条件，请务必将其停用](https://help.adjust.com/en/article/sdk-signature#manage-your-secret-ids)：
