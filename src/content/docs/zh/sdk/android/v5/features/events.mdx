...
versions:
   ...
   - label: v4
     value: v4
redirects:
   v4: /zh/sdk/android/v4/features/events
---
...
</Tabs> <CodeBlock title="事件日志" collapse="6-46">
...
</Tabs> <CodeBlock title="事件日志" highlight="{range: 7-8}">
...
</Tabs> <CodeBlock title="事件日志" highlight="{range: 7}">
