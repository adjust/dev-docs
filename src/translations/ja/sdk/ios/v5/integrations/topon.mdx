...
slug: "ja/sdk/ios/v5/integrations/topon"
---
...
Adjustで広告収益情報を記録するには、 `handleAdjustRevenueReport`関数内で`ADJAdRevenue`インスタンスを作成します。詳細については、 [広告収益情報の送信](/en/sdk/ios/features/ad-revenue)をご覧ください。
