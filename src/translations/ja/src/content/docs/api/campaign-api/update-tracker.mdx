...
| `tracker_token`\*   | 文字列       | パス       | 更新したいトラッカーのトークン。                                                                                     |
| `partner_id`        | 整数         | ボディ     | トラッカーに付与したいパートナーのID。partnersエンドポイントを使用して、パートナーとパートナーIDの一覧を取得します。 |
...
| `level`             | 整数         | トラッカーのレベル。以下の\[トラッカーレベル\]\(tracker\-levels\)を参照してください。 | `1`                                         |
