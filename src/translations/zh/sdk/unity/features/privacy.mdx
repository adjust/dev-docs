...
| `AdjustUrlStrategyChina` | 将 URL 测试指定到 `app.adjust.world` 域  |
| `AdjustUrlStrategyCn`    | 将 URL 测试指定到 `app.adjust.cn` 域     |
| `AdjustUrlStrategyIndia` | 将 URL 测试指定到 `app.adjust.net.in` 域 |
