...
const BuildMarkdownTable: FC<{
  ...
  const headerItems = el.querySelectorAll("body > table > thead > tr");
  const bodyItems = el.querySelectorAll("body > table > tbody > tr");
...
export default BuildMarkdownTable;
