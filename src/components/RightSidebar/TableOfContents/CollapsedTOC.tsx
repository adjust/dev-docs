...
const CollapsedTOC: FC<CollapsedTOCProps> = ({ setIsOpened }) => {
  return (
    <div className="fixed top-0 bottom-0 md:right-0 xxl:left-0 mt-32 xxl:ml-[calc(100vw-2rem-(100vw-100rem)/2)] items-start w-8 xxxl:hidden sm:hidden lg:flex z-10 border-[1px] border-t rounded-tl-lg border-bluish-grey">
      <button
