...
A full list of metrics is available in the [Datascape metrics glossary](https://help.adjust.com/en/article/datascape-metrics-glossary). You can also use the [Filters data endpoint](filters-data) to find a full list of metrics.
