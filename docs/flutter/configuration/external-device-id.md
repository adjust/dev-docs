...
Your config object contains a **string** `externalDeviceId` property that you can use to store your external device ID. You can set property calling the [`externalDeviceId` method](#flutter-externaldeviceid-invocation) with your ID as an argument.
...
:start-after: externalDeviceId snippet
