...
Your config object contains a **string** `externalDeviceId` property that you can use to store your external device ID. You can set property calling the [`externalDeviceId` method](#unity-setexternaldeviceid-invocation) with your ID as an argument.
